<template>
    <div>
        ...
        <el-tree ref="outlineTree" :data="treeData" :node-key="nodeKey" :props="treeProps"
            :default-expanded-keys="defaultExpandedKeys" :default-checked-keys="defaultCheckedKeys"
            :filter-node-method="filterNode" :current-node-key="selectId" :check-strictly='true' @node-click="clickNode"
