...
const graphData = {
  nodes:[
    ...
    // {id:"7_2",source: '7_2',target:"temp7_1_2",linkID: BASIC_DATA_SYS.forceExecute_caseLinktypeId,name:"强制执行",preNodes:[],position:{x: 1, y: 8},itemStyleColor: "",attributes:{modularity_class:'lct_13'}},
