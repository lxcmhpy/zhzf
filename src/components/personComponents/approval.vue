<template>
    <div>
        <div class="card-title">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;
            <el-button type="text" round style="margin-right:25px;float:right;" icon="el-icon-time" size="cats-common"
                @click="approvalHistory">审批历史</el-button>
        </div>
        <div>
            <div style="margin-top:35px;margin-bottom:25px;margin-left:25px;">
                <div class="approval-steps" style="margin-bottom: 30px;">
                    ...
                    <div v-if="tableData.length" class="steps-wrap">
                        <div class="steps-item" v-for="(item, $index) in tableData" :key="item.approveId">
        ...
        <div>
            <el-table style="margin-left:25px;width:97%;margin-bottom:35px;" :data="tableData" resizable align="center"
                stripe>
            ...
            <div class="paginationBox" style="margin-top:-25px;margin-bottom:10px;text-align:center;">
                <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange"
                    :current-page="currentPage" background :page-sizes="[10, 20, 30, 40, 50]"
                    layout="prev, pager, next,sizes,jumper" :total="totalPage"></el-pagination>
            </div>
        </div>
        <approvalHistory ref="approvalHistoryRef" :params="params" @getApprovalHistory="getApprovalRecordInfo">
        </approvalHistory>
    </div>
</template>
<script>
