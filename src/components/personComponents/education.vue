  ...
  <div>
    <div>
      <div class="card-title">
        ...
        <el-button v-if="params.type !== 'view'" type="primary" style="margin-right:25px;float:right;" icon="el-icon-plus" size="cats-common" @click="addEducation">新增学历</el-button>
      </div>
      <el-table style="margin-left:25px;width:97%;margin-bottom:35px;" :data="tableData" stripe resizable @selection-change="handleSelectionChange">
    ...
    <!-- 新增、修改、查看页面 -->
    <addEducationComp ref="addEducationCompRef" :params="params" @getEducationList="getEducation">
    </addEducationComp>
  </div>
</template>
