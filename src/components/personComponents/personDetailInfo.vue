                ...
                <el-row>
                  <el-col :span="12">
                    <el-form-item label="性别" prop="sexName">
                      <el-input v-model="personInfoDetailForm.sexName" :disabled='isDisabled'>
                      </el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="12">
                    <el-form-item label="出生日期" prop="birthDate">
                      <el-input v-model="personInfoDetailForm.birthDate" :disabled='isDisabled'>
                      </el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row>
                  <el-col :span="12">
                    <el-form-item label="民族" prop="nationName">
                      <el-select v-model="personInfoDetailForm.nationName" placeholder="民族" class="nation-select" :filterable="nationInfo.length > 5" :popper-append-to-body="false" @change="selectVal($event,'nation')">
                        <el-option v-for="value in nationInfo" :key="value.id" :label="value.name" :value="value.id"></el-option>
                      </el-select>
                    </el-form-item>
                  </el-col>
                  <el-col :span="12">
                    <el-form-item label="参加工作日期" prop="workDate">
                      <el-date-picker v-model="personInfoDetailForm.workDate" format="yyyy-MM-dd" value-format="yyyy-MM-dd" placeholder="请选择参加工作日期" clearable>
                      </el-date-picker>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row>
                  <el-col :span="12">
                    <el-form-item label="政治面貌" prop="politicalStatusName">
                      ...
                      <el-select v-model="personInfoDetailForm.politicalStatusName" placeholder="政治面貌" :loading="selectLoading" @change="selectVal($event,'politicalStatus')" @focus="getDictInfo('人员信息-政治面貌','politicalInfo')">
                        <el-option v-for="value in politicalInfo" :key="value.id" :label="value.name" :value="value.id">
                        </el-option>
                      </el-select>
                    </el-form-item>
                  </el-col>
                  <el-col :span="12">
                    <el-form-item label="入党日期" prop="admissionDate">
                      <el-date-picker v-model="personInfoDetailForm.admissionDate" format="yyyy-MM-dd" value-format="yyyy-MM-dd" placeholder="请选择入党日期" clearable>
                      </el-date-picker>
                    </el-form-item>
                  </el-col>
                </el-row>
                ...
                <el-row>
                  <el-col :span="12">
                    <el-form-item label="学历" prop="degree">
                      ...
                      <el-select v-model="personInfoDetailForm.degreeName" placeholder="学历" :loading="selectLoading" filterable @change="selectVal($event,'degree')" @focus="getDictInfo('人员信息-学历','degreeInfo')">
                        <el-option v-for="value in degreeInfo" :key="value.id" :label="value.name" :value="value.id">
                        </el-option>
                      </el-select>
                    </el-form-item>
                  </el-col>
                ...
                <el-row>
                  <el-col :span="12">
                    <el-form-item label="毕业专业" prop="major">
                      <el-select v-model="personInfoDetailForm.majorName" placeholder="毕业专业" :filterable="majorOptions.length > 5" :loading="selectLoading" @change="selectVal($event,'major')" @focus="getDictInfo('人员信息-毕业专业','majorOptions')">
                        <el-option v-for="value in majorOptions" :key="value.id" :label="value.name" :value="value.id">
                        </el-option>
                      </el-select>
                    </el-form-item>
                  </el-col>
                ...
                <el-row>
                  <el-col :span="12">
                    <el-form-item label="分配渠道" prop="disChannel">
                      ...
                      <el-select v-model="personInfoDetailForm.disChannelName" placeholder="分配渠道" :filterable="disChannelInfo.length > 5" :loading="selectLoading" @change="selectVal($event,'disChannel')" @focus="getDictInfo('人员信息-分配渠道','disChannelInfo')">
                        <el-option v-for="value in disChannelInfo" :key="value.id" :label="value.name" :value="value.id">
                        </el-option>
                      </el-select>
                    </el-form-item>
                  </el-col>
              ...
              <div class="info_body">
                <el-row v-if="isShowAddPerson">
                  <el-col :span="12">
                    <div v-if="pageParams.type">
                      <el-form-item label="所属机构" prop="oid">
                        <el-select disabled v-model="personInfoDetailForm.oid" placeholder="所属机构">
                          <el-option :key="personInfoDetailForm.oid" :label="personInfoDetailForm.oname" :value="personInfoDetailForm.oid">
                          </el-option>
                        </el-select>
                      </el-form-item>
                    </div>
                    <div v-else>
                      <el-form-item label="所属机构" prop="oid">
                        <elSelectTree v-if="showSelectTree" ref="elSelectTreeObj" :options="tableDataTree" :accordion="true" :props="props" @getValue="handleChanged">
                        </elSelectTree>
                        <el-input style="display:none" v-model="personInfoDetailForm.oid">
                        </el-input>
                      </el-form-item>
                    </div>
                  </el-col>
                  <el-col :span="12">
                    <el-form-item label="人员编制" prop="staffingName">
                      ...
                      <el-select v-model="personInfoDetailForm.staffingName" placeholder="人员编制" :filterable="staffingInfo.length > 5" :loading="selectLoading" @change="selectVal($event,'staffing')" @focus="getDictInfo('人员信息-人员编制','staffingInfo')">
                        <el-option v-for="value in staffingInfo" :key="value.id" :label="value.name" :value="value.id">
                        </el-option>
                      </el-select>
                    </el-form-item>
                  </el-col>
                ...
                <el-row>
                  <el-col :span="12">
                    <el-form-item label="职务" prop="postName">
                      ...
                      <el-select v-model="personInfoDetailForm.postName" placeholder="职务" :filterable="postInfo.length > 5" :loading="selectLoading" @change="selectVal($event,'post')" @focus="getDictInfo('人员信息-职务','postInfo')">
                        <el-option v-for="value in postInfo" :key="value.id" :label="value.name" :value="value.id">
                        </el-option>
                      </el-select>
                    </el-form-item>
                  </el-col>
                  <el-col :span="12">
                    <el-form-item label="岗位" prop="stationId">
                      ...
                      <el-select v-model="personInfoDetailForm.stationName" placeholder="岗位" :filterable="stationInfo.length > 5" :loading="selectLoading" @change="selectVal($event,'stationId')">
                        <el-option v-for="value in stationInfo" :key="value.id" :label="value.name" :value="value.id">
                        </el-option>
                      </el-select>
                    </el-form-item>
                  </el-col>
                ...
                <el-row>
                  <el-col :span="12">
                    <el-form-item label="执法领域" prop="branchName" :rules="{required: rules.branchName !== undefined, message: '执法领域必须填写', trigger: 'change' }">
                      <el-select v-model="personInfoDetailForm.branchName" placeholder="执法领域" :filterable="branchInfo.length > 5" :loading="selectLoading" clearable @change="selectVal($event,'branchId')" @focus="getDictInfo('执法门类','branchInfo')">
                        <el-option v-for="value in branchInfo" :key="value.id" :label="value.name" :value="value.id">
                        </el-option>
                      </el-select>
                    </el-form-item>
                  </el-col>
                  <el-col :span="12">
                    <el-form-item label="执法区域" prop="area" :rules="{ required: rules.branchName !== undefined, message: '执法区域不能为空', trigger: 'blur'}">
                ...
                <el-row>
                  <el-col :span="12">
                    <el-form-item label="从事执法日期" prop="enfoceDate">
                      ...
                      <el-date-picker v-model="personInfoDetailForm.enfoceDate" format="yyyy-MM-dd" value-format="yyyy-MM-dd" placeholder="请选择从事执法日期" clearable>
                      </el-date-picker>
                    </el-form-item>
                  </el-col>
                  <el-col :span="12">
                ...
                <el-row>
                  <el-col :span="12">
                    <el-form-item label="部级执法证号" prop="ministerialNo">
                      <el-input v-model="personInfoDetailForm.ministerialNo" maxlength="8">
                      </el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="12">
          ...
          <div class="info_box">
            ...
            <div class="info_content float" style="float:left">
              ...
              <div class="info_body">
                <el-row>
                  <el-col :span="12">
                    <el-form-item label="姓名：" prop="personName">{{personInfoDetailForm.personName}}
                    </el-form-item>
                  </el-col>
                  <el-col :span="12">
                    <el-form-item label="身份证号：" prop="idNo">{{personInfoDetailForm.idNo}}
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row>
                  <el-col :span="12">
                    <el-form-item label="性别：" prop="sexName">{{personInfoDetailForm.sexName}}
                    </el-form-item>
                  </el-col>
                  <el-col :span="12">
                    <el-form-item label="出生日期：" prop="birthDate">{{personInfoDetailForm.birthDate}}
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row>
                  <el-col :span="12">
                    <el-form-item label="民族：" prop="nationName">{{personInfoDetailForm.nationName}}
                    </el-form-item>
                  </el-col>
                  <el-col :span="12">
                    <el-form-item label="参加工作日期：" prop="workDate">{{personInfoDetailForm.workDate}}
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row>
          ...
          <div class="info_box">
            ...
            <div class="info_content">
              ...
              <div class="info_body">
                <el-row>
                  <el-col :span="12">
                    <el-form-item label="学历：" prop="degreeName">{{personInfoDetailForm.degreeName}}
                    </el-form-item>
                  </el-col>
                  <el-col :span="12">
                    <el-form-item label="毕业学校：" prop="school">{{personInfoDetailForm.school}}
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row>
                  <el-col :span="12">
                    <el-form-item label="毕业专业：" prop="major">{{personInfoDetailForm.majorName}}
                    </el-form-item>
                  </el-col>
                  <el-col :span="12">
                    <el-form-item label="毕业证书编号：" prop="graduationNo">
        ...
        <div class="info_box">
          ...
          <div class="info_content">
            ...
            <div class="info_body">
              <el-row>
                <el-col :span="12">
                  <el-form-item label="所属机构：" prop="oname">{{personInfoDetailForm.oname}}
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                  <el-form-item label="人员编制：" prop="staffingName">
              ...
              <el-row>
                <el-col :span="12">
                  <el-form-item label="职务：" prop="postName">{{personInfoDetailForm.postName}}
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                  <el-form-item label="岗位：" prop="stationName">{{personInfoDetailForm.stationName}}
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col :span="12">
                  <el-form-item label="执法领域：" prop="branchName">{{personInfoDetailForm.branchName}}
                  </el-form-item>
                </el-col>
                <el-col :span="12">
              ...
              <el-row>
                <el-col :span="12">
                  <el-form-item label="从事执法日期：" prop="enfoceDate">{{personInfoDetailForm.enfoceDate}}
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                  <el-form-item label="法律职业资格证号：" prop="lawCertNo">{{personInfoDetailForm.lawCertNo}}
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col :span="12">
                  <el-form-item label="省内执法证号：" prop="provinceNo">{{personInfoDetailForm.provinceNo}}
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                ...
                <el-col :span="12">
                  <el-form-item label="海事执法证号：" prop="maritimeNo">{{personInfoDetailForm.maritimeNo}}
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col :span="12">
                  <el-form-item label="证件办理状态：" prop="certStatusName">
                    {{personInfoDetailForm.certStatusName}}</el-form-item>
                </el-col>
                <el-col :span="12">
                  <el-form-item label="当前证件状态：" prop="currentCertStatusName">
...
export default {
  ...
  methods: {
    ...
    showPersonInfo(info) {
      ...
      if (info.photoUrl) {
        this.personImg =
          info.photoUrl.indexOf(this.baseUrl) > -1 ? info.photoUrl : this.baseUrl + info.photoUrl
      }
    },
    handleChanged(val) {
      ...
      if (_this.pageParams.type == 'edit') {
        ...
        if (this.checkChangeVal()) {
          const textNode = `<div>当前证件办理状态为<span style="color:red;font-weight: 600;">
            ...
            证件相关信息（姓名、身份证号、${confirmText}${confirmText ? '、' : ''}部级执法证号）
    ...
    checkChangeVal() {
      if (this.personInfoDetailForm.certStatusName !== '未申请') {
        ...
        const change =
          this.personClone.personName !== this.personInfoDetailForm.personName ||
    ...
    submitPersonInfo(messageName, methodSaveOrUpdate) {
      ...
      _this.$store.dispatch(methodSaveOrUpdate, _this.personInfoDetailForm).then(
        res => {
          if (res.code === 200) {
            _this.catsMessage({
              type: 'success',
    ...
    getNationOption() {
      let _this = this
      this.$store.dispatch('findAllDrawerByName', '人员信息-民族').then(res => {
        if (res.code === 200) {
