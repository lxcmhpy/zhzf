...
<template>
  <el-dialog
    ...
    <div class="select-avatar">
      ...
      <el-upload
        class="upload-person-img"
        list-type="picture-card"
        action=""
        :show-file-list="false"
        :auto-upload="false"
        :on-change="handleChange">
        <el-button size="medium">上传照片</el-button>
      </el-upload>
      <div class="cropper">
        <vueCropper
          ref="cropper"
  ...
  methods:{
    ...
    submitAvatar() {
      ...
      this.$refs.cropper.getCropBlob((data) => {
        const file = new File([data], this.selectFile.name, {type: this.selectFile.raw.type, lastModified: Date.now()});
