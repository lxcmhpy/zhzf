    ...
    <el-main>
      <el-row class="main">
        <el-row>
          <el-col
            :span="6"
            style="height: 60px; margin-top: 35px; margin-left: 100px"
          >
          ...
          <el-col
            :span="6"
            style="height: 60px; margin-left: -520px; margin-top: 28px"
          >
            <div class="title_3 title_font" @click="zbpage()">人员装备</div>
          </el-col>
          <el-col
            :span="4"
            style="height: 60px; margin-left: -30px; margin-top: 35px"
          >
            <div class="title_4">
          ...
          <el-col
            :span="4"
            style="height: 60px; margin-left: 0px; margin-top: 35px"
          >
            <div class="title_5">
    ...
    getData() {
      ...
      personEquipApi(param).then((res) => {
        if (res.code == 200) {
          ...
          res.data.increase.map((item, index) => {
            if (!index == 0) {
              let ratio = 0;
              if (res.data.increase[index - 1]) {
                let bef = res.data.increase[index - 1].value;
                ratio = (((item.value - bef) / bef) * 100).toFixed(2);
              }
              that.increaseSeries.push(ratio);
          ...
          var jiangxi =
            "../../../../static/json/map/data-1518338017111-rJK1gtpUM.json";
          var yingtan =
            "../../../../static/json/map/data-1518338860057-By447tpLf.json";
          var yichun =
            "../../../../static/json/map/data-1518338852969-Hy677KTIf.json";
          var xinyu =
            "../../../../static/json/map/data-1518338838010-SyAzQYTIf.json";
          var shangrao =
            "../../../../static/json/map/data-1518338829670-H1UfQYa8G.json";
          var pingxiang =
            "../../../../static/json/map/data-1518338823093-HkyMQtpUf.json";
          var nanchang =
            "../../../../static/json/map/data-1518338805373-S1Temta8G.json";
          var jiujiang =
            "../../../../static/json/map/data-1518338799987-S1deQFTLz.json";
          var jingdezhen =
            "../../../../static/json/map/data-1518338783915-HJOJXtaLf.json";
          var jian =
            "../../../../static/json/map/data-1518338772507-BJnAMKTIz.json";
          var ganzhou =
            "../../../../static/json/map/data-1518338763250-S17RfKpLM.json";
          var fuzhou =
            "../../../../static/json/map/data-1518338684239-S1EFGtp8f.json";
        ...
        that.preparedByFun();
        that.personNumFun();
        that.equipmentNumFun();
        that.increaseFun();
        that.equipmentTypeFun();
      });
      (err) => {
        console.log(err);
      };
