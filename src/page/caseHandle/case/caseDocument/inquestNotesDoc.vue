    ...
    <div class="a4-box" id="subOutputRank-print">
      <div class="pdf-box">
        ...
        <div class="pdf-report-info">
          <p>案由：
            <el-input class="pdf-line width635" v-model="caseName">&nbsp;</el-input>
          </p>
          <p>
              勘验时间：
              <span class="pdf-line width360">
                <el-date-picker v-model="inquestStartTime" type="date" format="yyyy 年 M 月 d 日 HH 时 mm 分" placeholder="  年  月  日 时 分" clear-icon='el-icon-circle-close'></el-date-picker>
              </span>
              至：
              <span class="pdf-line width200">
                <el-date-picker v-model="inquestEndTime" type="date" format="d 日 HH 时 mm 分" placeholder=" 日 时 分" clear-icon='el-icon-circle-close'></el-date-picker>
              </span>
            </p>
            <p>
              勘验场所：             
