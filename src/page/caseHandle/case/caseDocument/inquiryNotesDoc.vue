        ...
        <div class="pdf-report-info">
          <p>
              ...
              <span class="pdf-line width250">
                <el-date-picker v-model="inquiryStartTime" type="date" format="yyyy 年 M 月 d 日 HH 时 mm 分" placeholder="  年  月  日 时 分" clear-icon='el-icon-circle-close'></el-date-picker>
              </span>
              至
              <span class="pdf-line width150">
                <el-date-picker v-model="inquiryEndTime" type="date" format="d 日 HH 时 mm 分" placeholder=" 日 时 分" clear-icon='el-icon-circle-close'></el-date-picker>
              </span>
              第
                <el-input class="pdf-line width80" v-model="inquiryIndex">&nbsp;</el-input>  询问
            </p>
            <p>地点：
                <el-input class="pdf-line width635" v-model="inquiryAddress">&nbsp;</el-input>
            </p>
            <p>
              询问人：             
