  ...
  <div class="main">
    ...
    <div class="a4-box" id="subOutputRank-print">
      <div class="pdf-box">
        ...
        <div class="pdf-table">
          <table border="1" bordercolor="black" width="100%" cellspacing="0">
            ...
            <tr>
              ...
              <td> 名称</td>
              <td colspan="5">
                <el-input v-model="partyName" placeholder="请输入内容"></el-input>
              </td>
            </tr>
            <tr>
              <td> 地址</td>
              <td colspan="4">
                <el-input v-model="partyUnitAddress" :class="{'overWidth': overWidthFlag}" placeholder="请输入内容" @change="checkHeights"></el-input>
            ...
            <tr>
              <td> 联系电话</td>
              <td colspan="2">
                <el-input v-model="partyUnitTel" minlength="11" placeholder="请输入内容"></el-input>
              </td>
              <td> 法定代表人 </td>
              <td>
                <el-input v-model="partyManager" placeholder="请输入内容"></el-input>
              </td>
            </tr>
            <tr>
              <td colspan="2">
              ...
              <td colspan="3">
                <el-input v-model="socialCreditCode" placeholder="请输入内容"></el-input>
              </td>
            </tr>
          </table>
        </div>
        <div class="pdf-report-info">
            <p>
              ...
              <span class="pdf-line width264">
                <el-date-picker v-model="sampleStartTime" type="date" format="yyyy 年 M 月 d 日 HH 时 mm 分" placeholder="  年  月  日 时 分" clear-icon='el-icon-circle-close'></el-date-picker>
              </span>
              至：
              <span class="pdf-line width264">
                <el-date-picker v-model="sampleEndTime" type="date" format="M 月 d 日 HH 时 mm 分" placeholder=" 月 日 时 分" clear-icon='el-icon-circle-close'></el-date-picker>
              </span>
            </p>
            <p>抽样地点：
        ...
        <div class="pdf-table">
          <table v-mofel="tableDate" border="1" bordercolor="black" width="100%" cellspacing="0">
              <tr>
                  <td>序号</td>
                  <td>被抽样物品名称</td>
                  <td>规格及批号</td>
        ...
        <div class="pdf-report-info">
            <p>
              ...
              执法人员签名：
              <span class="pdf-line width150">
                <el-input v-model="staffSign" placeholder="请输入内容"></el-input>
              </span>
            </p>
            <div class="pdf-wirte">
              <div class="pdf-seal">
                <span @click='makeSeal'>交通运输执法部门（印章）</span><br>
                <el-date-picker v-model="makeDate" type="date" format="yyyy 年 M 月 d 日" placeholder="  年  月  日" clear-icon='el-icon-circle-close'>
                </el-date-picker>
              </div>
            </div>
            <p>
