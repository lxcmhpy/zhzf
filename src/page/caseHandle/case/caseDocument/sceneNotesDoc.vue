          ...
          <table class="print_table" border="1" bordercolor="black" width="100%" cellspacing="0">
            ...
            <tr>
              ...
              <td colspan="3" class="color_DBE4EF">
                <el-form-item
                  prop="vehicleShipId"
                  :rules="fieldRules('vehicleShipId',propertyFeatures['vehicleShipId'])"
                >
                  <el-input
              ...
              <td colspan="2" class="color_DBE4EF">
                <el-form-item
                  prop="vehicleShipType"
                  :rules="fieldRules('vehicleShipType',propertyFeatures['vehicleShipType'])"
                >
                  <el-select
                    v-model="docData.vehicleShipType"
                    :disabled="fieldDisabled(propertyFeatures['vehicleShipType'])"
                  >
                    <el-option
            ...
            <tr>
              ...
              <td colspan="7" class="illegalFactsTip">
                <span>
                  现场情况：（如实施行政强制措施的，包括当场告知当事人采取行政强制措施
