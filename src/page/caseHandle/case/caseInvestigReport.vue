<template>
  <div class="box">
    <el-form ref="docForm" :rules="rules" :model="docData" label-width="105px">
      ...
      <div class="content_box">
        <div class="content">
          ...
          <div class="content_form">
            ...
            <div class="row">
              <div class="col">
                <el-form-item prop="caseNumber" label="当事人类型"  class="line-height13">
                  <el-input ref="caseNumber" clearable class="w-120" v-model="docData.caseNumber" size="small" placeholder="请输入"></el-input>
                </el-form-item>
              </div>
            </div>
            <div class="row">
              <div class="col">
                <el-form-item prop="caseNumber" label="姓名">
                  <el-input ref="caseNumber" clearable class="w-120" v-model="docData.caseNumber" size="small" placeholder="请输入"></el-input>
                </el-form-item>
              </div>
              <div class="col">
                <el-form-item prop="caseNumber" label="性别">
                  <el-input ref="caseNumber" clearable class="w-120" v-model="docData.caseNumber" size="small" placeholder="请输入"></el-input>
                </el-form-item>
              </div>
              <div class="col">
                <el-form-item prop="caseNumber" label="年龄">
                  <el-input ref="caseNumber" clearable class="w-120" v-model="docData.caseNumber" size="small" placeholder="请输入"></el-input>
                </el-form-item>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col">
                <el-form-item prop="caseName" label="住址">
                  <el-input ref="caseName" clearable class="w-120" v-model="docData.caseName" size="small" placeholder="请输入"></el-input>
                </el-form-item>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col">
                <el-form-item label="违法事实">
                  <el-input type="textarea" class="height122" v-model="docData.partyManager" size="small" placeholder="请输入"></el-input>
                </el-form-item>
              </div>
            </div>
          </div>
            ...
            <el-table :data="tableDatas" stripe border style="width: 100%" height="100%">
              ...
              <el-table-column label="操作" align="center">
                <template slot-scope="scope">
                  <!-- {{scope.row.option}} -->
                  <i type="primary" class="el-icon-top cell-icon" @click="addDoc"></i>
            ...
            <div class="row">
              <div class="col">
                <el-form-item  label="调查结论">
                  <el-input type="textarea" class="height88" size="small" placeholder="请输入"></el-input>
                </el-form-item>
              </div>
            </div>
            <div class="row">
              <div class="col">
                <el-form-item  label="拟处罚类型" >
                  <el-checkbox-group v-model="docData.type">
                    <el-row>
                      <el-col :span="4">
                        <el-checkbox label="罚款" name="type"></el-checkbox>
                      </el-col>
                      <el-col :span="20">
                    ...
                    <el-row>
                      <el-col :span="4">
                        <el-checkbox label="责令改正" name="type"></el-checkbox>
                      </el-col>
                      <el-col :span="20">
                        <el-input v-model="docData.name"></el-input>
                      </el-col>
                    ...
                    <el-row>
                      <el-col :span="4">
                        <el-checkbox label="警告" name="type"></el-checkbox>
                      </el-col>
                      <el-col :span="20">
                        <el-input v-model="docData.name"></el-input>
                      </el-col>
                    ...
                    <el-row>
                      <el-col :span="4">
                        <el-checkbox label="没收违法所得" name="type"></el-checkbox>
                      </el-col>
                      <el-col :span="20">
                        <el-input v-model="docData.name"></el-input>
                      </el-col>
                    ...
                    <el-row>
                      <el-col :span="4">
                        <el-checkbox label="没收非法财产" name="type"></el-checkbox>
                      </el-col>
                      <el-col :span="20">
                        <el-input v-model="docData.name"></el-input>
                      </el-col>
                    ...
                    <el-row>
                      <el-col :span="10">
                        <el-checkbox label="责令停产停业、暂扣或吊销许可整合执照" name="type"></el-checkbox>
                      </el-col>
                      <el-col :span="14">
                        <el-input v-model="docData.name"></el-input>
                      </el-col>
            ...
            <div class="row">
              <div class="col">
                <el-form-item  label="拟重大案件">
                  <el-radio v-model="radio" label="1">拟定重大案件</el-radio>
                  <el-radio v-model="radio" label="2">非重大案件</el-radio>
                </el-form-item>
              </div>
            </div>
            <div class="row">
              <div class="col">
                <el-form-item label="处理意见">
                  <el-button class="el-button-remind" icon="el-icon-edit" @click="addIllegalAction" size="small">
                    生成意见
                  </el-button>
                  <el-input type="textarea" class="height162" size="small" placeholder="请输入"></el-input>
                </el-form-item>
              </div>
            </div>
          </div>
