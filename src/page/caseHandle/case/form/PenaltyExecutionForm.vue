<template>
  <div class="box PenaltyExecutionForm">
    ...
    >
            ...
            <div class="row">
              ...
              <div class="col">
                <el-form-item
                  ...
                  label="处罚类型"
                  :rules="
                    fieldRules('punishType', propertyFeatures['punishType'])
                  "
                >
                  <el-input
                    ref="punishType"
              ...
              <div class="col">
                <el-form-item label="执行方式">
                  <el-radio-group
                    ...
                    @change="changePayWay"
                    :rules="
                      fieldRules('performWay', propertyFeatures['performWay'])
                    "
                  >
            ...
            <div class="row">
              ...
              <div class="col">
                <el-form-item
                  ...
                  label="待缴金额"
                  :rules="
                    fieldRules('toPayAmount', propertyFeatures['toPayAmount'])
                  "
                >
            ...
            <div class="row">
              ...
              <div class="col">
                <el-form-item prop="checkbox">
                  <el-checkbox
                    v-model="formData.stepPay"
                    @change="changeStepPay"
                  ></el-checkbox>
                  分期（延期）缴纳
                </el-form-item>
              </div>
              ...
              <div class="col">
                <el-form-item prop="payEvidence" label="缴纳凭证">
                  ...
                  >
                    ...
                    <ul>
                      <li
                        v-for="(item, $index) in alreadyLoadPayEvidence"
                        :key="item.id"
                      >
                        <span @click.stop="evidenceDetail(item)">{{
                          item.fileName
                        }}</span
                        >&nbsp;&nbsp;<el-button
                          type="text"
      ...
      <div
        class="content_box"
        v-show="formData.performance || formData.stepPay"
      >
        <div class="content">
...
import { uploadEvApi, findFileByIdApi, deleteFileByIdApi } from "@/api/upload";
...
export default {
  ...
  methods: {
    ...
    handleChangePaidAmount(val) {
      ...
      console.log(
        "this.formData.tempPunishAmount",
        this.formData.tempPunishAmount
      );
      if (Number(this.totalMoney) == "NAN") {
        if (
          typeof this.totalMoney !== "number" &&
          typeof this.formData.tempPunishAmount !== "number"
        ) {
          this.totalMoney = this.RMBToNumber(this.totalMoney.replace("元", ""));
          this.formData.tempPunishAmount = this.RMBToNumber(
            this.formData.tempPunishAmount.replace("元", "")
          );
        }
      }
    ...
    handleIsTempPunishAmount() {
      if (this.fieldDisabled(this.propertyFeatures["tempPunishAmount"])) {
        ...
        this.formData.tempPunishAmount =
          until.upMoney(this.totalMoney) + "(" + this.totalMoney + "元)";
      }
    },
    ...
    deleteItem(row, index) {
      this.$confirm("确认删除文件吗？", "提示", {
        ...
        .then(() => {
          deleteFileByIdApi(row.storageId).then(() => {
            this.alreadyLoadPayEvidence.splice(index, 1);
          });
        })
        .catch(() => {});
    },
    ...
    setMoreDocTableTitle() {
      ...
      //查找是否为必填
      let payStageDoc_Require = this.docTableDatasCopy.find(
        (item) => item.docId == "2c9028ac6955b0c2016955bf8d7c0001"
      ).isRequired;
      if (this.formData.stepPay) {
        ...
        this.allAskDocList.forEach((element) => {
          if (
            element.docId == "2c9028ac6955b0c2016955bf8d7c0001" &&
        ...
        this.allDocCount = this.allAskDocList.length;
        if (this.formData.performance != "催告") {
          let indexCG = this.docTableDatas.findIndex(
            (item) => item.docId == "2c9029cf698f9e6c01698fd9e9000002"
          );
        ...
        if (this.formData.performance != "催告") {
          ...
          this.docTableDatas = this.docTableDatasCopy.filter((item) => {
            return item.docId != "2c9028ac6955b0c2016955bf8d7c0001";
          });
        }
      }
