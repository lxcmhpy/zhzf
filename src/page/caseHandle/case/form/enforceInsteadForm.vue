      ...
      <div class="content">
        ...
        <el-form ref="fieldRecordObj" :model="fieldRecordObj" :rules="rules" label-width="135px">
          <div class="content_form">
            ...
            <div class="row">
              <div class="col">
                <el-form-item prop="CONTACTOR" label="当事人身份证件号" class="line-height13">
            ...
            <div class="row">
              <div class="col">
                <el-form-item prop="CONTACTOR" label="当事人住址">
                  <el-input ref="CONTACTOR" clearable class="w-120" v-model="fieldRecordObj.type" size="small" placeholder="请输入"></el-input>
                </el-form-item>
              </div>
              <div class="col">
            ...
            <div class="row">
              <div class="col">
                <el-form-item prop="CONTACTOR" label="单位名称">
                  <el-input ref="CONTACTOR" clearable class="w-120" v-model="fieldRecordObj.type" size="small" placeholder="请输入"></el-input>
                </el-form-item>
              </div>
            </div>
            <div class="row">
              <div class="col">
                <el-form-item prop="CONTACTOR" label="单位地址">
                  <el-input ref="CONTACTOR" clearable class="w-120" v-model="fieldRecordObj.type" size="small" placeholder="请输入"></el-input>
                </el-form-item>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col">
                <el-form-item prop="CONTACTOR" label="单位统一社会信用代码" class="line-height13">
                  <el-input ref="CONTACTOR" clearable class="w-120" v-model="fieldRecordObj.type" size="small" placeholder="请输入"></el-input>
                </el-form-item>
              </div>
            </div>
