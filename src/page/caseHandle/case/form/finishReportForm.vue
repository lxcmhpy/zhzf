  ...
  <div class="box">
    ...
    <div class="content_box">
      <div class="content">
        ...
        <el-form ref="finishReportForm" :model="formData" :rules="rules" label-width="135px">
          ...
          <div class="content_form bottom_form">
            <el-form-item prop="closeResult" label="处理结果：">
              <el-input ref="closeResult" type="textarea" class="height106" v-model="formData.closeResult" size="small" placeholder="请输入"></el-input>
            </el-form-item>
            <el-form-item prop="closeSituation" label="执行情况：">
              <el-input ref="closeSituation" type="textarea" class="height122" v-model="formData.closeSituation" size="small" placeholder="请输入"></el-input>
            </el-form-item>
      ...
      <div class="float-btns">
        <el-button type="primary" @click="submitCaseDoc(1)" v-if="!approval">
          ...
          提交</el-button>
        <el-button type="success" @click="submitCaseDoc(0)" v-if="!approval">
...
export default {
  ...
  methods: {
    ...
    submitCaseDoc(handleType) {
      ...
      this.com_submitCaseForm(handleType,'finishReportForm',true);
    },
