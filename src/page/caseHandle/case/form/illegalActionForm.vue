  ...
  <div class="box">
    <div class="content_box">
      <div class="content">
        ...
        <el-form :inline="true" ref="illegalActionForm" :model="formData" label-width="135px" :rules="rules">
          <div class="border_blue"></div>
          <div class="content_form">
            <div class="row">
              <div class="col">
                <el-form-item label="案号：" prop="caseNumber">
                  <el-input :disabled="true" ref="caseNumber" clearable class="w-120" v-model="formData.caseNumber" size="small" placeholder="请输入"></el-input>
                </el-form-item>
              </div>
            </div>
            <div class="row">
              <div class="col">
                <el-form-item prop="party" label="当事人姓名：">
                  <el-input ref="party" :disabled="true" clearable class="w-120" v-model="formData.party" size="small" placeholder="请输入"></el-input>
                </el-form-item>
              </div>
            </div>
            <div class="row">
              <div class="col">
                <el-form-item label="违法行为：">
                  <el-input ref="caseCauseNameCopy" :disabled="true" clearable class="w-120" v-model="formData.caseCauseNameCopy" size="small" placeholder="请输入"></el-input>
                </el-form-item>
              </div>
            </div>
            <div class="row">
              <div class="col">
                <el-form-item label="违法依据：">
                  <el-input ref="illegalBasis" clearable class="w-120" v-model="formData.illegalBasis" size="small" placeholder="请输入"></el-input>
                </el-form-item>
              </div>
            </div>
            <div class="row">
            ...
            <div class="row">
              <div class="col">
                <el-form-item label="拟处罚决定：">
                  <el-input ref="punishDecision" :disabled="true" clearable class="w-120" v-model="formData.punishDecision" size="small" placeholder="请输入"></el-input>
                </el-form-item>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              ...
              <div class="col">
                <el-form-item label="邮编：">
                  <el-input ref="partyZipCode" clearable class="w-120" v-model="formData.partyZipCode" size="small" placeholder="请输入"></el-input>
                </el-form-item>
              </div>
            </div>
            <div class="row">
