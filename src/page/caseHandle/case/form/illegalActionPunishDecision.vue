  ...
  >
    <div id="illegalActionPunishDecisionBox">
      <el-checkbox-group v-model="checkDec">
        <p><el-checkbox label="罚款" value="0"   v-model="checkDec">罚款</el-checkbox><el-input placeholder="请输入罚款金额" v-model="cont1" :disabled="checkDec[0]=='罚款'?false:true"></el-input></p>
        <p><el-checkbox label="责令整改" value="1"  v-model="checkDec1">责令整改</el-checkbox><el-input placeholder="请输入责令整改要求" v-model="cont2" :disabled="checkDec[1]=='责令整改'?false:true"></el-input></p>
        <p><el-checkbox label="警告" value="2"  v-model="checkDec2">警告</el-checkbox><el-input placeholder="请输入警告内容" v-model="cont3" :disabled="checkDec[2]=='警告'?false:true"></el-input></p>
        <p><el-checkbox label="没收违法所得" value="3"  v-model="checkDec3">没收违法所得</el-checkbox><el-input placeholder="请输入罚款金额" v-model="cont4" :disabled="checkDec[3]=='没收违法所得'?false:true"></el-input></p>
        <p><el-checkbox label="没收非法财产" value="4"  v-model="checkDec4">没收非法财产</el-checkbox><el-input placeholder="请输入非法财产内容" v-model="cont5" :disabled="checkDec[4]=='没收非法财产'?false:true"></el-input></p>
        <p><el-checkbox label="责令停产停业、暂扣或吊销许可整合执照" value="5"  v-model="checkDec5">责令停产停业、暂扣或吊销许可整合执照</el-checkbox><el-input placeholder="非必填" v-model="cont6" :disabled="checkDec[5]=='责令停产停业、暂扣或吊销许可整合执照'?false:true"></el-input></p>
      </el-checkbox-group>
    </div>
