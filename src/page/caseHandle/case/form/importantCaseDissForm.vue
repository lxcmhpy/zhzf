      ...
      <div class="content">
        ...
        <el-form ref="docForm" :model="docData" :rules="rules" label-width="135px">
          ...
          <div class="content_form bottom_form">
            <el-form-item prop="caseNumber" label="讨论时间：">
            ...
            <el-form-item prop="note" label="讨论地点：">
              <el-input v-model="docData.note" size="small" placeholder="请输入"></el-input>
            </el-form-item>
            <div class="row">
                <div class="col">
            ...
            <div class="row">
                ...
                <div class="col">
                  <el-form-item label="出席人：">
                    <el-input ref="partySex" clearable class="w-120" v-model="docData.partySex" size="small" placeholder="请输入"></el-input>
                  </el-form-item>
                </div>
            </div>
            <el-form-item prop="caseBasicSituation" label="讨论记录：">
              <el-input type="textarea" class="height122" v-model="docData.caseBasicSituation" size="small" placeholder="请输入"></el-input>
            </el-form-item>
            <el-form-item prop="note" label="结论性意见：">
              <el-input v-model="docData.note" size="small" placeholder="请输入"></el-input>
            </el-form-item>
          </div>
        </el-form>
