...
import {findPropertyById,savePropertyInvolved,updatePropertyInvolved} from "@/api/propertyManage";
    ...
    data() {
        return {
            ...
            rules:{
                ...
                "dispose.disposeWay": [{required: true, message: '请选择处理方式', trigger: 'change'}]
            },
            unitOptions:[],
    ...
    methods: {
        ...
        submitForm(){
            ...
            this.$refs['form'].validate(valid => {
                if (valid) {
                    this.setCaseIds();
                    if(!_this.form.dispose.disposeWay || _this.form.dispose.disposeWay === ""){
