      ...
      <div class="print_info">
        ...
        <p>
          ...
          <el-form-item rows='2' prop="caseCauseName" :rules="fieldRules('caseCauseName',propertyFeatures['caseCauseName'])" style="width: 300px">
            <el-input :disabled="fieldDisabled(propertyFeatures['caseCauseName'])" v-model="docData.caseCauseName"
                      type='textarea' v-bind:class="{ over_flow:docData.caseCauseName.length>14?true:false }"
  ...
  export default {
    ...
    data() {
      ...
      var validateIfDate = (rule, value, callback) => {
        var diff = new Date(value).getTime() - new Date(this.docData.measureStartDate).getTime();
          ...
          res => {
            ...
            getOrganDetailApi(orgData).then(
              orgRes => {
                ...
                // _this.docData.reconsiderationOrgan = 'reconsiderationOrgan1';
                // _this.docData.lawsuitOrgan = 'enforcementOrgan1';
