      ...
      <el-form :rules="rules" ref="docForm" :inline-message="true" :inline="true" :model="docData">
       ...
       <table class="print_table" border="1" bordercolor="black" width="100%" cellspacing="0">
        ...
        <p>本机关于
          ...
          <span>
            <el-form-item prop="punishContent"  class="width151" :rules="fieldRules('punishContent',propertyFeatures['punishContent'])">
        ...
        <p>
          ...
          <span>
            <el-form-item prop="measureAction"  class="width235" :rules="fieldRules('measureAction',propertyFeatures['measureAction'])">
