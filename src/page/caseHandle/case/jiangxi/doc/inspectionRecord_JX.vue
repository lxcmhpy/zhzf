      ...
      >
        ...
        <p class="p_begin">
          ...
          <span class="listen_data">
            <el-form-item
              ...
              :rules="
                fieldRules(
                  'inspectStartTime',
                  propertyFeatures['inspectStartTime']
                )
              "
            >
              <el-date-picker
          ...
          <span class="listen_data">
            <el-form-item
              ...
              class="pdf_datapick"
              :rules="
                fieldRules('inspectEndTime', propertyFeatures['inspectEndTime'])
              "
            >
              <el-date-picker
        ...
        <p class="p_begin">
          ...
          <span>
            <el-form-item
              ...
              class="width537"
              :rules="
                fieldRules('inspectPlace', propertyFeatures['inspectPlace'])
              "
            >
              <el-input
        ...
        <p class="p_begin">
          ...
          <span>
            <el-form-item
              ...
              class="width505"
              :rules="
                fieldRules('inspectContent', propertyFeatures['inspectContent'])
              "
            >
              <el-input
        ...
        <p class="p_begin">
          ...
          <el-form-item
            ...
            :rules="
              fieldRules(
                ...
                propertyFeatures['staffUnitAndPosition1']
              )
            "
          >
            <el-input
              ...
              v-bind:class="{
                over_flow:
                  docData.staffUnitAndPosition1 &&
                  docData.staffUnitAndPosition1.length > 14
                    ? true
                    : false,
              }"
              ...
              maxlength="35"
              :disabled="
                fieldDisabled(propertyFeatures['staffUnitAndPosition1'])
              "
          ...
          <el-form-item
            ...
            style="width: 130px"
            :rules="
              fieldRules('certificateId1', propertyFeatures['certificateId1'])
            "
          >
            <el-input
          ...
          <el-form-item
            ...
            :rules="
              fieldRules(
                ...
                propertyFeatures['staffUnitAndPosition2']
              )
            "
          >
            <el-input
              ...
              v-bind:class="{
                over_flow:
                  docData.staffUnitAndPosition2 &&
                  docData.staffUnitAndPosition2.length > 14
                    ? true
                    : false,
              }"
              :autosize="{ minRows: 1, maxRows: 2 }"
              ...
              maxlength="35"
              :disabled="
                fieldDisabled(propertyFeatures['staffUnitAndPosition2'])
              "
            ></el-input> </el-form-item
          >执法证号：
          <el-form-item
            ...
            style="width: 130px"
            :rules="
              fieldRules('certificateId2', propertyFeatures['certificateId2'])
            "
          >
            <el-input
            ...
            <el-form-item
              ...
              :rules="
                fieldRules(
                  ...
                  propertyFeatures['partyUnitAndPosition']
                )
              "
            >
              <el-input
                ...
                :maxLength="maxLength"
                :disabled="
                  fieldDisabled(propertyFeatures['partyUnitAndPosition'])
                "
              ></el-input>
            </el-form-item>
          </span>
        ...
        <div class="overflow_lins_style">
          <div class="overflow_lins">
            <el-form-item
              prop="inspectRecord"
              :rules="
                fieldRules('inspectRecord', propertyFeatures['inspectRecord'])
              "
            >
              <el-input
  ...
  methods: {
    starttime() {
      if (this.docData.inspectEndTime) {
        ...
        if (
          Date.parse(this.docData.inspectStartTime) <
          ...
          this.docData.inspectStartTime > this.docData.inspectEndTime
        ) {
          this.$message({
