            ...
            <td rowspan="2" colspan="8" class="color_DBE4EF">
              ...
              >
                <el-input
                  ...
                  v-bind:class="{ over_flow:formData.reason && formData.reason.length>14?true:false }"
                  :autosize="{ minRows: 1, maxRows: 5}"
                  maxlength="200"
                  placeholder="\"
              ...
              <div>
                ...
                >
                  ...
                  <p>
                    ...
                    <el-input
                      v-model="formData.stageNum"
                      type="textarea"
                      :autosize="true"
                      v-bind:class="{ over_flow:formData.stageNum.length>2?true:false }"
                      style="width: 45px"
                      v-bind:disabled="!two"
                    ></el-input>期至
                    <el-date-picker
                      v-model="formData.stageDate"
                      type="date"
                      format="yyyy年MM月dd日"
                      value-format="yyyy-MM-dd"
                      placeholder="  年  月  日"
                    ...
                    <el-input
                      v-model="formData.payFine"
                      type="textarea"
                      :autosize="true"
                      v-bind:class="{ over_flow:formData.payFine.length>6?true:false }"
                      style="width: 100px"
                      v-bind:disabled="!two"
                    ></el-input>元（大写）。尚有未缴纳的罚款
                    <el-input
                      v-model="formData.debtFine"
                      type="textarea"
                      rows="1"
                      :autosize="true"
                      v-bind:class="{ over_flow:formData.debtFine.length>6?true:false }"
                      style="width: 100px"
                      v-bind:disabled="!two"
                    ></el-input>元（大写）。
                  </p>
...
export default {
  ...
  methods: {
    ...
    test2(val){
      if(val){
        this.formData.checkBox = "1";
        this.one = false;
        this.three = false;
      }else{
        this.formData.checkBox = "";
        this.formData.stageNum = "";
        this.formData.stageDate = "";
      }
    },
    test3(val){
      if(val){
        this.formData.checkBox = "2";
        this.one = false;
        this.two = false;
      }else{
        this.formData.checkBox = "";
    ...
    if(this.formData.checkBox=="0"){
      this.one = true;
    }else if (this.formData.checkBox=="1"){
      this.two = true;
    }else if (this.formData.checkBox=="2"){
      this.three = true;
    }
  },
  created() {
