...
export default {
  ...
  data() {
    ...
    return {
      ...
      caseLinkDataForm: {
        ...
        caseLinktypeId: this.BASIC_DATA_JX.removeOrPrelong_JX_caseLinktypeId, //表单类型ID
        //表单数据
        formData: "",
        status: ""
      },
  ...
  methods: {
    ...
    submitCoerciveMeasuer() {
      let params = {
        caseId: this.caseId,
        caseLinktypeId: this.BASIC_DATA_JX.removeOrPrelong_JX_caseLinktypeId
      };
    ...
    getDocListByCaseIdAndFormId() {
      let data = {
        linkTypeId: this.BASIC_DATA_JX.removeOrPrelong_JX_caseLinktypeId //环节ID
      };
