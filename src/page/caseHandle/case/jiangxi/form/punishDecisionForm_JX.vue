      ...
      <div class="content_box">
        <div class="content">
          ...
          <div class="content_form">
            ...
            <div class="row">
              <div class="col">
                <el-form-item prop="tempPunishAmount" label="实际处罚金额" :rules="fieldRules('tempPunishAmount',propertyFeatures['tempPunishAmount'])">
            ...
            <div class="row">
              <div class="col">
                <el-form-item label="案件基本情况" prop="illegalBasis" :rules="fieldRules('illegalBasis',propertyFeatures['illegalBasis'])">
            ...
            <div class="row">
              <div class="col">
                <el-form-item label="违法事实及依据" prop="illegalBasis" :rules="fieldRules('illegalBasis',propertyFeatures['illegalBasis'])">
                  <el-input :disabled="fieldDisabled(propertyFeatures['illegalBasis'])" ref="illegalBasis" clearable class="w-120" v-model="formData.caseCauseName" size="small" placeholder="请输入" ></el-input>
                </el-form-item>
              </div>
            </div>
            <div class="row">
              <div class="col">
                <el-form-item label="处罚决定" prop="illegalBasis" :rules="fieldRules('illegalBasis',propertyFeatures['illegalBasis'])">
                  <el-input :disabled="fieldDisabled(propertyFeatures['illegalBasis'])" ref="illegalBasis" clearable class="w-120" v-model="formData.caseCauseName" size="small" placeholder="请输入" ></el-input>
                </el-form-item>
              </div>
            </div>
