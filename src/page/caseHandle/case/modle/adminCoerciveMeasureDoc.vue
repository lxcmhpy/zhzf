          ...
          <p>
            <span>
              <el-form-item prop="afsj" class="pdf_datapick">
                <el-date-picker v-model="docData.afsj" type="date" format="yyyy年MM月dd日" placeholder="    年  月  日">
                </el-date-picker>
              </el-form-item>
            </span>，你（单位）
            <span>
            ...
            <span>
              <el-form-item prop="punishLaw">
                <el-input  v-model="docData.punishLaw" type='textarea'  v-bind:class="{ over_flow:docData.party.length>14?true:false }" :autosize="{ minRows: 1, maxRows: 3}"   :maxLength='maxLength' placeholder="\"></el-input>
              </el-form-item>
            </span>的规定，本机关决定对你（单位）的
            <span>
              <el-form-item prop="detainGoods">
                <el-input v-model="docData.detainGoods" :maxLength='maxLength' placeholder="\"></el-input>
              </el-form-item>
            </span>（财物、设施或场所的名称及数量）实施
            <span>
              <el-form-item prop="enforceMeasure">
                <el-select v-model="docData.enforceMeasure" :maxLength='maxLength' placeholder="\">
            ...
            <span>
              <el-form-item prop="measureStartDate" class="pdf_datapick">
                <el-date-picker v-model="docData.measureStartDate"  @change="startTime" type="date" format="yyyy年MM月dd日" placeholder="    年  月  日">
                </el-date-picker>
              </el-form-item>
            </span>至
            <span>
              <el-form-item prop="measureEndDate" class="pdf_datapick">
                <el-date-picker v-model="docData.measureEndDate" type="date" format="yyyy年MM月dd日" placeholder="    年  月  日">
                </el-date-picker>
              </el-form-item>
            </span>。
          </p>
          ...
          <p>
            ...
            <span>
              <el-form-item prop="lawsuitOrgan">
                <el-select v-model="docData.lawsuitOrgan" :maxLength='maxLength' placeholder="\">
          ...
          <p>
            ...
            <span>
              <el-form-item prop="caseName">
                <el-input type='textarea' v-model="docData.caseName" v-bind:class="{ over_flow:docData.party.length>14?true:false }" :autosize="{ minRows: 1, maxRows: 3}" :maxLength='maxLength' placeholder="\"></el-input>
              </el-form-item>
            </span>
          </p>
  ...
  methods: {
    ...
    getDocDataByCaseIdAndDocId() {
      let data = {
        ...
        docId: '4028e4ef63683cd00163684359a10001'
      };
    ...
    startTime(){
      if (this.docData.measureStartDate){
        this.$set(this.docData, 'measureEndDate', new Date(this.docData.measureStartDate.getTime() + 29 * 24 * 3600 * 1000));
      }
    },
