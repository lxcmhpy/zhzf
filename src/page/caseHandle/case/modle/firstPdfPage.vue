    ...
    <div class="print_info">
      <el-form :rules="rules" ref="docForm" :inline-message="true" :inline="true" :model="docData" :class="isPdf">
        <div class="first_page_box">
          ...
          <div class="first_casenumber">
            案号<span class="case_number">云曲运政罚[2018]年0001号{{formData.caseNumber}}</span>
          </div>
          <div class="table_box">
            <table class="print_table" border="1" bordercolor="black" width="100%" cellspacing="0">
              ...
              <tr>
                <td colspan="2">当事人</td>
                <td colspan="3" class="text_left">{{formData.party}}</td>
              </tr>
              <tr>
