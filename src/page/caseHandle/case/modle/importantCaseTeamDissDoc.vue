      ...
      <el-form :rules="rules" ref="docForm" :inline-message="true" :inline="true" :model="docData">
        ...
        <p class="p_begin">
          ...
          <span>
            <el-form-item
              prop="reporter"
              class="width130"
              :rules="fieldRules('reporter',propertyFeatures['reporter'])"
            >
              <el-input
                v-model="docData.reporter"
                maxlength="7"
                :disabled="fieldDisabled(propertyFeatures['reporter'])"
              ></el-input>
            </el-form-item>
          </span>
          记录人：
        ...
        <div class="overflow_lins_style">
          <div class="overflow_lins">
            <el-form-item
              prop="presentMembersName"
              :rules="fieldRules('presentMembersName',propertyFeatures['presentMembersName'])"
            >
              <el-input
                class="text_indent10 overflow_lins_textarea"
                type="textarea"
                v-model="docData.presentMembersName"
                rows="4"
                maxlength="200"
                :disabled="fieldDisabled(propertyFeatures['presentMembersName'])"
              ></el-input>
        ...
        <div class="overflow_lins_style">
          <div class="overflow_lins">
            <el-form-item
              prop="discussionRecord"
              :rules="fieldRules('discussionRecord',propertyFeatures['discussionRecord'])"
            >
              <el-input
                class="text_indent10 overflow_lins_textarea"
                type="textarea"
                v-model="docData.discussionRecord"
                rows="10"
                maxlength="1500"
                :disabled="fieldDisabled(propertyFeatures['discussionRecord'])"
              ></el-input>
