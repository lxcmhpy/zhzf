      ...
      <el-form :rules="rules" ref="docForm" :inline-message="true" :inline="true" :model="docData">
          ...
          <tr>
            ...
            <td colspan="2" class="color_DBE4EF">
              <el-form-item prop="party">
                <el-input type='textarea' v-model="docData.party" v-bind:class="{ over_flow:docData.party.length>14?true:false }" :autosize="{ minRows: 1, maxRows: 3}" :maxlength="nameLength"></el-input>
            ...
            <td colspan="2" class="color_DBE4EF">
              <el-form-item prop="partyIdNo">
                <el-input v-model="docData.partyIdNo" :maxLength='maxLength'></el-input>
              </el-form-item>
            </td>
          </tr>
          <tr>
            ...
            <td colspan="2" class="color_DBE4EF">
              <el-form-item prop="partyAddress">
                <el-input type='textarea' v-model="docData.partyAddress" v-bind:class="{ over_flow:docData.partyAddress.length>14?true:false }" :autosize="{ minRows: 1, maxRows: 3}" :maxlength="adressLength"></el-input>
              </el-form-item>
            </td>
            <td>联系电话</td>
            <td colspan="2" class="color_DBE4EF">
          ...
          <tr>
            ...
            <td colspan="5" class="color_DBE4EF">
              <el-form-item prop="partyName">
                <el-input v-model="docData.partyName" :maxLength='maxLength'></el-input>
              </el-form-item>
            </td>
          </tr>
          <tr>
            ...
            <td colspan="4" class="color_DBE4EF">
              <el-form-item prop="partyUnitAddress">
                <el-input v-model="docData.partyUnitAddress" :maxLength='maxLength'></el-input>
              </el-form-item>
            </td>
          </tr>
          <tr>
            ...
            <td colspan="2" class="color_DBE4EF">
              <el-form-item prop="partyUnitTel">
                <el-input v-model="docData.partyUnitTel" minlength="11" :maxLength='maxLength'></el-input>
              </el-form-item>
            </td>
            <td> 法定代表人 </td>
          ...
          <tr>
            ...
            <td colspan="3" class="color_DBE4EF">
              <el-form-item prop="socialCreditCode">
                <el-input v-model="docData.socialCreditCode" :maxLength='maxLength'></el-input>
              </el-form-item>
            </td>
          </tr>
        </table>
        ...
        <p>你(单位)的行为违反了<span>
            <el-form-item prop="illegalLaw">
              <el-input type='textarea' v-model="docData.illegalLaw"  v-bind:class="{ over_flow:docData.party.length>14?true:false }" :autosize="{ minRows: 1, maxRows: 3}" :maxLength='maxLength'></el-input>
          ...
          <span>
            <el-form-item prop="tempPunishAmount">
              <el-input type='textarea' v-model="docData.tempPunishAmount"  v-bind:class="{ over_flow:docData.party.length>14?true:false }" :autosize="{ minRows: 1, maxRows: 3}" :maxLength='maxLength'></el-input>
              <!-- <el-input v-model="docData.tempPunishAmount" :maxLength='maxLength'></el-input> -->
            </el-form-item>
          </span>的行政处罚。
          <p>
            罚款的履行方式和期限(见打√处)：
          ...
          <p>
            <input type="checkbox">自收到本决定书之日起十五日内缴至<span>
              ...
              <el-form-item prop="account">
                <el-input v-model="docData.account" :maxLength='maxLength'></el-input>
              </el-form-item>
