  ...
  <div class="box" id="noPenaltyBox">
    ...
    <div class="content_box">
        ...
        <div class="float-btns "> 
          <el-button :type="formData.reason && originalData.reason ? 'primary' : 'info'" :disabled="!canGoNextLink" @click="continueHandle" v-if="!this.$route.params.isComplete">
           <svg t="1577515608465" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2285" width="24" height="24">
            ...
            下一<br>环节</el-button>
          <el-button :type="formData.reason && originalData.reason ? 'info' : 'primary'" :disabled="canGoNextLink" @click="submitCaseDoc(1)" v-if="!this.$route.params.isComplete">
...
import { findByCondition,deleteDocByIdApi,deleteFileByCaseAndHuanjieApi,queryFlowBycaseIdApi,
    } from "@/api/caseHandle";
import {
  uploadEvApi,
  findFileByIdApi,
