<template>
  <div class="main">
      ...
      >
        ...
        <div class="pdf-report-info">
          ...
          <p>
            ...
            日，本机关对你（单位）送达了（案号）《行政处罚决定书》，作出了对你（单位）罚款
            <span class="pdf-line width250">&nbsp;</span>。
            （大写）的行政处罚决定，根据你（单位）的申请，本机
          ...
          <p>
            ...
            <span class="pdf-line width80">&nbsp;</span>年
            <span class="pdf-line width80">&nbsp;</span>月
            <span class="pdf-line width80">&nbsp;</span>日前，缴纳罚款
            <span class="pdf-line width80">&nbsp;</span>元（大写）（每期均应当单独开具本文书）。此外，尚有未缴纳的罚款
            <span class="pdf-line width80">&nbsp;</span>元（大写）。
          </p>
          <p>
            <input type="checkbox" />由于
            <span class="pdf-line width430">&nbsp;</span>
    ...
    <!-- <div class="float-btns">
      <el-button type="success">
        <svg t="1577706357599" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2136" width="16" height="16">
          <path d="M153.6 0h716.8v102.4H153.6zM0 153.6v614.4h153.6v256h716.8v-256h153.6V153.6z m768 768H256v-307.2h512z m153.6-563.2h-153.6V256h153.6z" p-id="2137" fill="#FFFFFF" />
        </svg>
        <br />打印
      </el-button>
      <el-button type="success">
        <svg t="1577706400265" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="3033" width="16" height="16">
          <path d="M946.176 896a34.304 34.304 0 0 1 0 68.608H77.824a34.304 34.304 0 0 1 0-68.608h868.352z m0-622.08L401.92 818.176 189.44 839.68l21.504-211.968 473.088-473.088 71.168-71.168c31.744-31.744 87.552-31.744 119.296 0l71.168 71.168c15.872 15.872 24.576 37.376 24.576 59.904 0.512 22.016-8.192 43.52-24.064 59.392zM266.24 762.88l103.936-10.752 431.616-431.616-93.696-93.696L276.48 658.432 266.24 762.88zM815.104 127.488c-4.096 0-8.192 1.536-11.264 4.608l-46.592 46.592 93.696 93.696 46.592-46.592c6.144-6.144 6.144-16.384 0-22.528l-71.168-71.168c-3.072-3.072-7.168-4.608-11.264-4.608z" p-id="3034" fill="#FFFFFF" />
        </svg>
        <br />编辑
      </el-button>
      <el-button type="success">
    ...
    <casePageFloatBtns :pageDomId="'payStage-print'" :formOrDocData="formOrDocData" @submitData="submitData" @saveData="saveData" @backHuanjie="submitData"></casePageFloatBtns>
  ...
  data() {
    return {
      ...
      formOrDocData: {
        ...
        pageDomId: 'payStage-print',
      },
      caseDocDataForm: {
        id: "", //修改的时候用
        caseBasicinfoId: '', //案件id
        caseDoctypeId: "2c9028ac6955b0c2016955bf8d7c0001", //文书模版ID
        docData: '',
        status: ''
      }
    };
