          ...
          <tr>
            ...
            <td rowspan="2" colspan="8" class="color_DBE4EF">
              <el-form-item prop="caseName" :rules="fieldRules('caseName',propertyFeatures['caseName'])">
                <el-input type="textarea" v-model="formData.caseName" :disabled="fieldDisabled(propertyFeatures['caseName'])" :autosize="{ minRows: 2, maxRows: 3}" maxlength="90" placeholder="\"></el-input>
              </el-form-item>
            </td>
          </tr>
          <tr></tr>
          <tr>
            ...
            <td colspan="8" class="color_DBE4EF">
              <el-form-item prop="afsj" :rules="fieldRules('afsj',propertyFeatures['afsj'])" class="pdf_datapick">
                <el-date-picker v-model="formData.afsj" :disabled="fieldDisabled(propertyFeatures['afsj'])" type="datetime" format="yyyy年MM月dd日" value-format="yyyy-MM-dd HH:mm"></el-date-picker>
              </el-form-item>
            </td>
          </tr>
          <tr>
            ...
            <td colspan="8" class="color_DBE4EF">
              <el-form-item prop="payTime" :rules="fieldRules('afdd',propertyFeatures['afdd'])">
                <el-input type="textarea" v-model="formData.afdd" :disabled="fieldDisabled(propertyFeatures['afdd'])" :autosize="{ minRows: 2, maxRows: 3}" maxlength="90" placeholder="\"></el-input>
              </el-form-item>
            </td>
          </tr>
          <tr>
            ...
            <td colspan="8" class="color_DBE4EF">
              <el-form-item prop="payParty" :rules="fieldRules('payParty',propertyFeatures['payParty'])">
                <el-input type="textarea" v-model="formData.payParty" :disabled="fieldDisabled(propertyFeatures['payParty'])" :autosize="{ minRows: 2, maxRows: 3}" maxlength="90" placeholder="\"></el-input>
              </el-form-item>
            </td>
          </tr>
          <tr>
            ...
            <td colspan="8" class="color_DBE4EF">
              <el-form-item prop="payTime" :rules="fieldRules('payTime',propertyFeatures['payTime'])">
                <el-date-picker v-model="formData.payTime" :disabled="fieldDisabled(propertyFeatures['payTime'])" type="datetime" format="yyyy年MM月dd日" value-format="yyyy-MM-dd HH:mm"></el-date-picker>
              </el-form-item>
            </td>
          </tr>
