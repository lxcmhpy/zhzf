<template>
  <div class="print_box printNumbers_box" id="removeAdminCoerciveMeasureApproval_SC_print" style="width:790px; margin:0 auto;">
    <el-form
      :rules="rules"
      ref="docForm"
      :inline-message="true"
    ...
    >
      <div class="print_info" style="height: auto">
        <div class="doc_topic">解除行政强制措施审批表</div>
        ...
        <table class="print_table prolong_table" border="1" bordercolor="black" width="100%" cellspacing="0">
          ...
          <tr>
            ...
            <td colspan="10" class="color_DBE4EF">
              ...
              <div class="pdf_seal alginLast" style="white-space:nowrap;width:auto;margin-top:60%;margin-right:80px;">
...
<style lang="scss">
#removeAdminCoerciveMeasureApproval_SC_print{
  .prolong_table {
    table-layout: fixed;
