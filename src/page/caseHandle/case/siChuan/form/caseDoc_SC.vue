<template>
  <div class="box">
    <el-form ref="caseDocForm" :model="formData" :rules="rules" label-width="115px">
      ...
      <div class="content_box">
        <el-checkbox-group v-model="formData.dynamicSelectDocArr" style="margin-top:20px">
          <el-checkbox label="属于重大行政处罚"></el-checkbox>
          <el-checkbox label="采取抽样取证"></el-checkbox>
          <el-checkbox label="采取证据登记保存"></el-checkbox>
          <el-checkbox label="解除证据登记保存"></el-checkbox>
          <el-checkbox label="重大案件讨论"></el-checkbox>
        </el-checkbox-group>
        <div class="content">
          <el-row :gutter="20">
            <el-col :span="16">
...
export default {
  ...
  methods: {
    ...
    filterDoc([showCF,showCY,showBCZJ,showJCZJ,showZDAJ]){
      ...
      if(showCY){ //抽样取证
        this.docTableDatas.push(this.docTableDatasCopy.find(item=> item.path == "case_handle_obtaineEvidenceForm"))
      }else{
