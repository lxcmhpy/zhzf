      ...
      <el-form :model="caseData" :rules="rules" ref="caseData" label-width="100px" class="demo-ruleForm">
                ...
                <el-dialog title="选择目标机构" :visible.sync="visibleOrgan" @close="visibleOrgan = false" :close-on-click-modal="false" width="40%" append-to-body>
                  <div class="chooseLawPer">
                    <div class="choosed">
                      ...
                      <div>
                        <el-tag v-if="checkedOrgan !== ''" closable :disable-transitions="false" @close="deleteUser()">{{checkedOrgan}}
                        </el-tag>
                      </div>
                    </div>
                    <div class="choose">
                      ...
                      <div class="organList">
                        ...
                        <el-tree :data="organList" show-checkbox check-strictly node-key="id" ref="organTree" :filter-node-method="filterNode" @check-change="handleCheckChange">
                        </el-tree>
        ...
        <el-form-item label="附件">
          ...
          <ul class="file-upload">
            ...
            <li class="file-upload-li" v-for="item in fileListArr" :key="item.id" v-on:mouseover="mouseoverFile()" v-on:mouseout="mouseoutFile()">
...
<!-- <el-upload
  ...
  <div slot="tip" class="el-upload__tip">只能上传jpg/png文件，且不超过500kb</div>
        ...
        <center>
          <el-button type="primary" @click="submitForm('caseData')" style="width:174px;margin-bottom:74px;margin-top:70px">提交
          </el-button>
        </center>
      </el-form>
    </div>
