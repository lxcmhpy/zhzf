              ...
              <div class="text-left">
                ...
                >
                  ...
                  >
                    ...
                    <p>
                      <el-checkbox label="上级交办">
                        3.上级机关
                        <el-form-item
                          v-if="!lineStyleFlag"
                          prop="reconsiderationOrgan"
                          style="margin-top:-8px;border-bottom:1px solid black"
                        >
                          <el-input
...
export default {
  data() {
    ...
    var validateIfCom = (rule, value, callback) => {
      if (!this.isParty && !value) {
        return callback(
          new Error("法定代表人、地址、联系电话、信用代码不能为空")
        );
      }
      callback();
    };
  ...
  methods: {
    ...
    getCaseInfo() {
      ...
      this.$store
        .dispatch("getCaseBasicInfo", data)
        .then((res) => {
