          ...
          <div class="item">
            <el-form-item label="案件来源" prop="caseSource">
              <el-select ref="caseSource" v-model="inforForm.caseSource" placeholder="请选择" @change="changeCaseSource">
                <el-option v-for="item in allcaseSource" :key="item.value" :label="item.label" :value="item"></el-option>
              </el-select>
            </el-form-item>
          </div>
          <div class="item hasMargintop">
            <el-form-item prop="caseSourceText">
              <el-input ref="caseSourceText" v-model="inforForm.caseSourceText" v-show="caseSourceTextDisable" :placeholder="caseSourceTextPla"></el-input>
            </el-form-item>
          </div>
        </div>
        <div>
      ...
      <div class="caseFormBac" id="link_2" ref="link_2" @mousewheel="scrool2">
        ...
        <div v-show="partyTypePerson=='1'">
          ...
          <div class="item appendSelect">
            <el-form-item label="证件类型" prop="partyIdNo">
              <el-input ref="partyIdNo" placeholder="请输入内容" v-model="inforForm.partyIdNo" @change="changePartyIdType(inforForm.partyIdNo)" class="input-with-select hasMargintop">
        ...
        <div class="driverOrAgentBox" v-for="(driverOrAgentInfo,index) in driverOrAgentInfoList" :key="index">
          ...
          <div>
            ...
            <div class="item appendSelect">
              <el-form-item label="证件类型" prop="partyIdNo">
                <el-input ref="partyIdNo" placeholder="请输入内容" v-model="driverOrAgentInfo.zhengjianNumber" @change="changePartyIdType2(driverOrAgentInfo.zhengjianNumber,index)" class="input-with-select hasMargintop" :disabled="index==0&&relationWithPartyIsOne[index]">
