        ...
        <div class="searchAndpageBox toggleBox">
            ...
            <div class="tablePart">
                ...
                <el-table :data="tree" border style="width: 100%;">
                                        ...
                                        <template slot-scope="scope">
                                            <div style="margin-left: 47px">
                                                <el-table :data="scope.row.children" border style="width: 100%;">
                                                    ...
                                                    <el-table-column v-else prop="oneSore" label="得分">
                                                    </el-table-column>
                                                    <el-table-column v-if="
                                                            form.pfStatus ===
                                                                '0'
                                                        " prop="season" label="扣分原因">
                                                        <template slot-scope="scope">
                                                            <el-input v-model="
                                                                    scope.row
                                                                        .season
                    ...
                    <el-table-column prop="indexOne"> </el-table-column>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            commitData() {
                var re = /^[0-9]([0-9])*$/;
                let validata = this.pykhScoreDetailsVos.find(
                    value => value.oneSore === null || !re.test(value.oneSore)
                );
                if (validata) {
                    this.catsMessage({
                        type: "warning",
                    ...
                    updateScore(row).then(
                        res => {
                            ...
                            this.pykhScoreDetailsVos.forEach(function (item) {
                                sum += parseInt(
                                    item.oneSore === null ? "0" : item.oneSore
                                );
                            });
            ...
            fetchData() {
                ...
                getCaseInfoDetailByPid(this.$route.params.id).then(
                    res => {
                        ...
                        // let tree = [];
                        let firstIdList = filterId(
                            _this.pykhScoreDetailsVos,
                            "indexOneId"
                        );
                        ...
                        firstIdList.forEach((v, i) => {
                            ...
                            if (index > -1) {
                                obj.indexOne =
                                    _this.pykhScoreDetailsVos[index].indexOne;
                                obj.indexOneId =
                                    _this.pykhScoreDetailsVos[index].indexOneId;
                                // obj.nrxm = _this.pykhScoreDetailsVos[index].nrxm;
                            }

                            let secondList = _.filter(
                                _this.pykhScoreDetailsVos,
                                function (o) {
                            ...
                            secondIdList.forEach((v2, i) => {
                                ...
                                if (index2 > -1) {
                                    obj2.indexTwo =
                                        _this.pykhScoreDetailsVos[index2].indexTwo;
                                    obj2.indexTwoId =
                                        _this.pykhScoreDetailsVos[
                                            index2
                                        ].indexTwoId;
                                    let thirdList = _.filter(
                                        _this.pykhScoreDetailsVos,
                                        function (o) {
                                            return (
                                                o.indexOneId === v &&
