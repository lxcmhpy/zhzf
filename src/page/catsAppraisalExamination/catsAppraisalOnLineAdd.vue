    ...
    <div class="cats-layout-page-content">
        <div class="searchAndpageBox toggleBox">
                ...
                <div class="search">
                    <el-form :inline="true" :model="form" ref="form">
                        ...
                        <div v-if="form.pfStatus==='0'">
                            <el-form-item>
                                <el-button type="primary" size="cats-common" icon="el-icon-search" @click="commitData">
                                    提交
                                </el-button>
                            </el-form-item>
                        </div>
            ...
            <div class="tablePart">
                ...
                <!-- :span-method="tree" -->
                <!-- default-expand-all -->
                <el-table :data="tree" border style="width: 100%;">
                    <el-table-column type="expand">
                        <template slot-scope="scope1">
                            <div style="margin-left: 47px">
                                <!-- {{scope1.children}} -->
                                <el-table :data="scope1.row.children" border style="width: 100%;">
                                    <el-table-column type="expand">
                                        <template slot-scope="scope">
                                            <div style="margin-left: 47px">
                                                <el-table :data="scope.row.children" border style="width: 100%;">
                                                    <el-table-column prop="nrxm" label="评查内容">
                                                    </el-table-column>
                                                    <el-table-column prop="score" label="单项分值">
                                                    </el-table-column>
                                                    <el-table-column v-if="form.pfStatus==='0'" prop="twoSore"
                                                        label="得分">
                                                        <template slot-scope="scope">
                                                            <el-input v-model="scope.row.twoSore"
                                                                @blur="saveRecord(scope.row,'twoSore')"
                                                                @focus="getOldValue(scope.row.twoSore)"></el-input>
                                                        </template>
                                                    </el-table-column>
                                                    <el-table-column v-else prop="twoSore" label="得分">
                                                    </el-table-column>
                                                    <el-table-column v-if="form.pfStatus==='0'" prop="season"
                                                        label="扣分原因">
                                                        <template slot-scope="scope">
                                                            <el-input v-model="scope.row.season"
                                                                @blur="saveRecord(scope.row,'season')"
                                                                @focus="getOldValue(scope.row.season)"></el-input>
                                                        </template>
                                                    </el-table-column>
                                                    <el-table-column v-else prop="season" label="扣分原因">
                                                    </el-table-column>
                                    ...
                                    <el-table-column prop="indexTwo">
                                    </el-table-column>
                                </el-table>
                            </div>
                        </template>
                    </el-table-column>
                    <el-table-column prop="indexOne">
                    </el-table-column>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            commitData() {
                var re = /^[0-9]([0-9])*$/;
                let validata = this.form.pykhScoreDetailsVos.find(value => value.twoSore === null || !re.test(value
                    .twoSore))
                if (validata) {
                    this.catsMessage({
                        type: "warning",
                ...
                getOrgInfoById(this.$route.params.id).then(
                    res => {
                        ...
                        firstIdList.forEach((v, i) => {
                            ...
                            let secondList = _.filter(_this.form.pykhScoreDetailsVos, function (o) {
                                return o.indexOneId === v;
                            });
                            ...
                            secondIdList.forEach((v2, i) => {
                                ...
                                if (index2 > -1) {
                                    ...
                                    obj2.indexTwoId = _this.form.pykhScoreDetailsVos[index2]
                                        .indexTwoId;
                                    let thirdList = _.filter(_this.form.pykhScoreDetailsVos,
                                        function (o) {
                                            return o.indexOneId === v && o.indexTwoId === v2;
                                        });
