                ...
                <div class="search">
                    <el-form :inline="true" :model="form" ref="form">
                        ...
                        <div v-if="form.pfStatus==='1'">
                            ...
                            <el-form-item>
                                <el-button type="primary" size="cats-common" icon="el-icon-search" @click="viewFile">
                                    查看附件
                                </el-button>
                            </el-form-item>
                        </div>
                                        ...
                                        <template slot-scope="scope">
                                            <div style="margin-left: 47px">
                                                <el-table :data="scope.row.children" border style="width: 100%;">
                                                    ...
                                                    <el-table-column prop="oneSore" label="初评得分">
                                                    </el-table-column>
                                                    <el-table-column v-if="form.pfStatus==='1'" prop="twoSore"
                                                        label="得分">
                                                        <template slot-scope="scope">
                                                    ...
                                                    <el-table-column v-if="form.pfStatus==='1'" prop="season"
                                                        label="扣分原因">
                                                        <template slot-scope="scope">
                ...
                getCaseInfoDetailByPid(this.$route.params.id).then(
                    res => {
                        ...
                        firstIdList.forEach((v, i) => {
                            ...
                            let secondList = _.filter(_this.pykhScoreDetailsVos, function (o) {
                            ...
                            secondIdList.forEach((v2, i) => {
                                ...
                                if (index2 > -1) {
                                    ...
                                    let thirdList = _.filter(_this.pykhScoreDetailsVos, function (
                                        o) {
