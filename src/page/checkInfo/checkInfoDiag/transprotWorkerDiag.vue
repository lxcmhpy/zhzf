<template>
  <el-dialog
    ...
    append-to-body
  >
    <el-form :model="dlyscyryForm" ref="dlyscyryForm" class="errorTipForm">
        <div align="center">
            <table class="tg">
                <tr>
...
export default {
  ...
  methods: {
    transportWorkerSee(data) {
      this.visible = true;
      this.dialogTitle = "道路运输从业人员";
      this.dlyscyryForm = data;
    },
    //关闭弹窗的时候清除数据
    closeDialog() {
      this.visible = false;
      this.$refs["dlyscyryForm"].resetFields();
    },
  }
};
</script>
