            ...
            <div class="searchPage toggleBox">
                ...
                <div class="tablePart">
                    ...
                    >
                        ...
                        <el-table-column prop="storageLocation" label="配发后存放位置"></el-table-column>
                ...
                <el-dialog :title="title"
                    ...
                    <el-form
                        ...
                        <div class="part">
                            ...
                            <el-row>
                            <el-form-item label="配发后存放位置" prop="storageLocation">
                                <el-input v-model="addForm.storageLocation" style="width: 100%;" :readonly="this.formReadOnly"></el-input>
                            </el-form-item>
                            </el-row>
                            <el-row>
                            <el-form-item label="单据日期" prop="billDate">
                                <el-date-picker v-model="addForm.billDate" type="date" value-format="yyyy-MM-dd" format="yyyy-MM-dd" style="width: 100%;" :readonly="this.formReadOnly"></el-date-picker>
                            </el-form-item>
                            </el-row>
                            <el-row>
