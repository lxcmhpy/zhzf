    ...
    <el-form
      ...
      <el-row>
        <el-form-item label="参数值:" prop="paramValue">
          <el-input v-if="updateParamForm.paramName!='APPROVE_ORGAN2' && updateParamForm.paramName!='APPROVE_ORGAN3'" v-model="updateParamForm.paramValue"></el-input>
          <elSelectTree
            v-else
            ref="elSelectTreeObj"
...
import { getAllOrigin,updateParam } from "@/api/device/param.js";
export default {
  ...
  methods:{
    ...
    submitParam() {
      ...
      _this.$refs.updateParamFormRef.validate((valid) => {
        if (valid) {
          updateParam(_this.updateParamForm).then(res => {
    ...
    showModal(row) {
      ...
      _this.updateParamForm.organId=row.organId;
