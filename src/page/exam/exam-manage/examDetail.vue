    ...
    <el-dialog
        ...
        <el-form :model="examPersonForm" ref="examPersonFormRef" label-position="right" label-width="100px;" :inline="true">
            <div>
                ...
                <el-row>
                    <el-form-item label="考场" prop="branchName" class-form="form-class">
                ...
                <el-row>
                    <el-form-item>
                        <el-button type="primary"  icon="el-icon-plus" size="medium" @click="getAddPersonInfo('','1')">批量打印准考证</el-button>
                        <el-button type="primary" icon ="el-icon-delete-solid" size="medium" @click="deleteAddPerson">导出考场核对表</el-button>
                        <el-button type="primary"  icon ="el-icon-delete-solid" size="medium" @click="deleteAddPerson">到处成绩</el-button>
                    </el-form-item>
                </el-row>
            </div>
             </el-form>
            <div>
                <el-table :data="tableDate" resizable stripe style="width:98%">
                    ...
                    <el-table-column prop="branchName" label="考场" align="center"></el-table-column>
                    <el-table-column prop="branchName" label="成绩" align="center"></el-table-column>
                    <el-table-column prop="opt" label="操作" align="center"  width="250px">
                        <template slot-scope="scope">
                            ...
                            <el-button type="text" @click="selectPage(scope.row)">答卷详情</el-button>
                        </template>
                    </el-table-column>
                </el-table>
            </div>
...
export default {
    ...
    components:{
        addExamPerson,invigilateCard,roomNotes
    },
    methods:{
        showModal(type,data){
            let _this = this 
        ...
        invigilateCard(){  //准考证
            this.$refs.invigilateCardCompRef.showModal('1',"");
        },
        roomNotes(){  //考场记录
