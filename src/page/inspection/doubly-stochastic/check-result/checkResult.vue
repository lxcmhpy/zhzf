    ...
    <div class="searchAndpageBox inspection-info" id="roleBox" style="height:calc(100% - 22px)">
      ...
      <div class="tablePart">
        <el-table :data="tableData" stripe style="width: 100%" height="100%" @selection-change="handleSelectionChange">
          ...
          <el-table-column prop="checkType" label="对象名称" align="center"></el-table-column>
          <el-table-column prop="checkType" label="项目名称" align="center"></el-table-column>
          ...
          <el-table-column prop="checkBasis" label="检查状态" align="center"></el-table-column>
          <el-table-column prop="checkBasis" label="检查评价" align="center"></el-table-column>
          <el-table-column prop="checkBasis" label="检查结果" align="center"></el-table-column>
          <el-table-column fixed="right" label="操作" align="center">
            <template slot-scope="scope">
              ...
              <el-button type="text" @click="delMethod(scope.row.id)">检查</el-button>
            </template>
          </el-table-column>
        </el-table>
      </div>
