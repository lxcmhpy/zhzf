    ...
    <div class="searchAndpageBox" id="roleBox">
      ...
      <div class="tablePart">
        <el-table :data="tableData" stripe style="width: 100%" height="100%" @selection-change="handleSelectionChange">
          ...
          <el-table-column prop="domain" label="业务领域" align="center" width="100"></el-table-column>
          <el-table-column prop="title" label="模板标题" align="center"></el-table-column>
          <el-table-column prop="title" label="模板管理者" align="center"></el-table-column>
          <el-table-column prop="title" label="关联文书" align="center"></el-table-column>
          <el-table-column prop="isTransferToCase" label="转立案" align="center"></el-table-column>
...
import {
  findRecordlModleByNameApi, findRecordModleByIdApi, removeMoleByIdApi, findRecordlModleByPageApi,
  findRecordModleByNameIdApi, findRecordModleByPersonApi, findUserCollectTemplateApi, removeMoleCollectByIdApi
} from "@/api/inspection";
import Vue from 'vue'
