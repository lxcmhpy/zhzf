        ...
        <div v-show="partyTypePerson=='1'">
          ...
          <div class="item appendSelect">
            <el-form-item label="证件类型" prop="partyIdNo">
              <el-input ref="partyIdNo" placeholder="请输入内容" v-model="inforForm.partyIdNo" class="input-with-select hasMargintop">
        ...
        <div v-show="partyTypePerson=='1'">
          ...
          <div class="itemThird">
            <el-form-item label="年龄" prop="partyAge">
              <el-input ref="partyAge" v-model="inforForm.partyAge" type="number" :disabled="inforForm.partyIdNo?true:false" @change="noFue('inforForm.partyAge',inforForm.partyAge)"></el-input>
            </el-form-item>
          </div>
          <div class="itemThird">
        ...
        <div v-show="partyTypePerson=='1'">
          <div class="itemThird">
            <el-form-item label="省/市/区">
              <el-cascader ref="areaCascader" v-model="inforForm.provincesAddressArray" :options="provincesList" @active-item-change="handleSelect" :props="{ expandTrigger:'hover',label:'name',value:'name'}" filterable @change="handleSelect"></el-cascader>
            </el-form-item>
          </div>
          <div class="itemThird">
          ...
          <div class="itemSmall">
            <el-form-item label="邮编" prop="partyZipCode">
              <el-input ref="partyZipCode" @change="changeDriverOrAgentInfo" v-model="inforForm.partyZipCode" @blur="blur3($event.target.value)"></el-input>
            </el-form-item>
          </div>
        </div>
        <div v-show="partyTypePerson=='1'">
              ...
              <div class="item">
                <el-form-item label="与当事人关系">
                  <el-select v-model="driverOrAgentInfo.relationWithParty" @change="changeRelationWithParty(index)">
                    <el-option v-for="item in index === 0?allRelationWithParty:allRelationWithParty_" :key="item.value" :label="item.label" :value="item.label"></el-option>
                  </el-select>
                </el-form-item>
              </div>
              <div class="item">
                ...
                <el-form-item label="与案件关系">
                  <el-select v-model="driverOrAgentInfo.relationWithCase" :disabled="index==0&&relationWithPartyIsOne[index]">
          ...
          <div>
            <div class="item">
              <el-form-item label="姓名">
                <el-input v-model="driverOrAgentInfo.name" :disabled="index==0&&relationWithPartyIsOne[index]"></el-input>
              </el-form-item>
            </div>
            <div class="item appendSelect">
              <el-form-item label="证件类型" prop="partyIdNo">
                <el-input ref="partyIdNo" placeholder="请输入内容" v-model="driverOrAgentInfo.zhengjianNumber" @input="changePartyIdType2Index = index" class="input-with-select hasMargintop" :disabled="index==0&&relationWithPartyIsOne[index]">
                  <el-select slot="prepend" v-model="driverOrAgentInfo.zhengjianType" :disabled="index==0&&relationWithPartyIsOne[index]">
                    <el-option v-for="item in credentialType" :key="item.value" :label="item.label" :value="item.value" :disabled="index==0&&relationWithPartyIsOne[index]"></el-option>
                  </el-select>
                </el-input>
              </el-form-item>
            </div>
          ...
          <div>
            ...
            <div class="itemThird">
              <el-form-item label="年龄">
                <el-input v-model="driverOrAgentInfo.age" type="number" :disabled="index==0&&relationWithPartyIsOne[index]" @change="noFueA(driverOrAgentInfo.age)"></el-input>
              </el-form-item>
            </div>
            <div class="itemThird">
              <el-form-item label="联系电话">
                <el-input v-model="driverOrAgentInfo.tel" :disabled="index==0&&relationWithPartyIsOne[index]" @blur="blur2($event.target.value)"></el-input>
              </el-form-item>
            </div>
          </div>
          <div>
            <div class="itemThird">
              <el-form-item label="省/市/区">
                <el-cascader :ref="subAreaCascader+index" v-model="driverOrAgentInfo.provincesAddress" :options="provincesList" @active-item-change="(params)=>handleSelectDriverOrAgent(params,index,driverOrAgentInfo)" :props="{ expandTrigger:'hover',label:'name',value:'name'}" filterable :disabled="index==0&&relationWithPartyIsOne[index]" @change="(params)=>handleSelectDriverOrAgent(params,index,driverOrAgentInfo)"></el-cascader>
              </el-form-item>
            </div>
            <div class="itemThird">
              <el-form-item label="详细地址">
                <el-input v-model="driverOrAgentInfo.adress" :disabled="index==0&&relationWithPartyIsOne[index]"></el-input>
              </el-form-item>
            </div>
            <div class="itemSmall">
              <el-form-item label="邮编">
                <el-input v-model="driverOrAgentInfo.adressCode" :disabled="index==0&&relationWithPartyIsOne[index]" @blur="blur3($event.target.value)"></el-input>
              </el-form-item>
            </div>
          </div>
          <div>
            <div class="itemBig">
              <el-form-item label="工作单位">
                <el-input v-model="driverOrAgentInfo.company" :disabled="index==0&&relationWithPartyIsOne[index]"></el-input>
              </el-form-item>
            </div>
            <div class="itemSmall">
              <el-form-item label="职务">
                <el-input v-model="driverOrAgentInfo.position" :disabled="index==0&&relationWithPartyIsOne[index]"></el-input>
              </el-form-item>
            </div>
          </div>
          <div>
            <div class="itemOne">
              <el-form-item label="从业资格证号">
                <el-input v-model="driverOrAgentInfo.zigeNumber" :disabled="index==0&&relationWithPartyIsOne[index]"></el-input>
              </el-form-item>
            </div>
          </div>
          <!-- 分隔线 -->
        ...
        <div>
          ...
          <div class="itemSmall">
            <el-form-item label="检测时间" prop="checkTime">
              <el-date-picker ref="checkTime" v-model="inforForm.otherInfo.checkTime" type="datetime" format="yyyy-MM-dd HH:mm" value-format="yyyy-MM-dd HH:mm"></el-date-picker>
            </el-form-item>
          </div>
        </div>
        <div>
