      ...
      <div class="handlePart caseHandleSearchPart">
        ...
        >
          ...
          <div :class="{hideSomeSearchClass:hideSomeSearch}">
            ...
            <div class="item">
              <el-form-item label="评查状态">
                <el-select v-model="caseSearchForm.pcStatue" placeholder="请选择">
                    <el-option v-for="(item,index) in allPCStatue" :key="index" :label="item.label" :value="item.value"></el-option>
                </el-select>
              </el-form-item>
            </div>
          </div>
...
<script>
import {queryCaseByEvaluationListApi} from '@/api/lawEnforcementSupervision'
