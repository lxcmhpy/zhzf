        ...
        <div class="searchPage">
            ...
            <div class="tablePart">
                ...
                >
                    ...
                    <el-table-column prop="vehicleColor" label="车辆颜色" :formatter="formatVehicleColor" align="center"></el-table-column>
                        ...
                        <el-row :gutter="20">
                                ...
                                <el-col :span="12">
                                    <el-form-item label="车辆颜色" prop="vehicleColor">
                                            <el-select v-model="addForm.vehicleColor" clearable style="width: 100%;" :disabled="this.formReadOnly">
                                                <el-option
                                ...
                                <el-col :span="12">
                                    <el-form-item label="车辆类型" prop="vehicleType">
                                            <el-select v-model="addForm.vehicleType" clearable style="width: 100%;" :disabled="this.formReadOnly">
                                                <el-option
                                ...
                                <el-col :span="12">
                                    <el-form-item label="道路运输证号" prop="roadTransportNumber">
                                            <el-input v-model="addForm.roadTransportNumber" style="width: 100%;" :readonly="this.formReadOnly"></el-input>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="12">
                                    <el-form-item label="年份" prop="year">
...
<script>
    import { queryEmphasisVehicle,findEmphasisVehicleById,saveOrUpdateEmphasisVehicle,deleteEmphasisVehicleById} from "@/api/lawSupervise.js";;
    ...
    export default {
        ...
        methods: {
            ...
            async getDrawerDataList(){
                let data = []
                data.push({pid:'388c5ac24cde480df1a54bc97829a481',fieldName:'vehicleColorList'})
                data.push({pid:'758832d166deeeb0b533de2ec0303507',fieldName:'vehicleTypeList'})
                let res = await this.$store.dispatch("getDrawerList", data)
                this.vehicleColorList=res.data.vehicleColorList
                this.vehicleTypeList=res.data.vehicleTypeList
            },
            formatVehicleColor(row){
                let data = this.vehicleColorList.filter(p=>p.id==row.vehicleColor)
            ...
            saveOrUpdate(formName){
                ...
                this.$refs[formName].validate(valid => {
                    if (valid) {
                        ...
                        saveOrUpdateEmphasisVehicle(_this.addForm).then(
                            res => {
                                _this.$message({
                                    type: "success",
                                    message:"保存成功!"
            ...
            queryData(val) {
                ...
                let _this = this
                queryEmphasisVehicle(this.queryForm).then(res => {
            ...
            handleEdit(index, row) {
                this.title="修改重点车辆"
                this.findEmphasisVehicleById(row)
                this.formReadOnly = false
                this.visible = true
            },
            //查看详情
            ...
            findEmphasisVehicleById(row){
                let _this = this
                findEmphasisVehicleById(row.id).then(
                    res => {
            ...
            deleteRecord(row) {
                let _this = this
                this.$confirm("确认删除该重点车辆?", "提示", {
                    confirmButtonText: "确定",
                    cancelButtonText: "取消",
                    type: "warning"
                })
                .then(() => {
                    deleteEmphasisVehicleById(row.id).then(
                        res => {
