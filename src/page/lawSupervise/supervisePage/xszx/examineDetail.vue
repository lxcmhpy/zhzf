...
<div class="main_box">
    ...
    <div v-if="tabActiveValue=='检测数据核对'" class="main_content" style="margin-top: 24px">
    ...
    <div v-if="tabActiveValue=='违法超限复合'">违法超限复合</div>
    <div v-if="tabActiveValue=='生成证据包'">生成证据包</div>
    <btns></btns>
</div>
</template>
