            ...
            <div class="handlePart">
                <div class="search">
                    <el-form :inline="true" :model="listAwardForm"  ref="listAwardForm">
                        ...
                        <el-form-item>
                            <el-button type="primary" icon="el-icon-plus" size="medium" @click="addAwardComPage">新增</el-button>
                            <el-button type="warning" size="medium" @click="editAward(scope.row)">修改</el-button>
                            <el-button type="info" icon="el-icon-search" size="medium" @click="getAward">查询</el-button>
