            ...
            <div class="handlePart">
                <div class="search">
                     <el-form :inline="true" :model="examDeployForm"  ref="examDeployFormRef">
                        ...
                        <el-form-item>
                            <el-button type="info" icon="el-icon-search" size="medium" @click="getStationList">查询</el-button>
                            <el-button type="primary" size="medium" @click="resetLog">重置</el-button>
                            <el-button type="primary" icon="el-icon-plus" size="medium" @click="stationInfo('',0)">新增</el-button>
                            <el-button type="primary" icon="el-icon-plus" size="medium" @click="stationInfo('',3)">手动</el-button>
                        </el-form-item>
                    </el-form>
                </div>
            </div>
...
export default {
    ...
    change(event, row) {
      ...
      .then(() => {
        ...
        this.$store.dispatch("resumeScheduleJobInfo", data).then(res => {
          if (res.code === 200) {
            row.isUse = event;
          }
        }, err => {
