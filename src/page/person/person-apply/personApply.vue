  ...
  <div class="searchPageLayout" id="userBox">
    <div class="searchPage">
      <div class="handlePart">
        <el-form class="search-form" :inline="true" ref="userForm" :model="formInline"  label-width="70px">
          <el-row>  
...
export default {
  ...
  methods: {
    ...
    //跳转页面执行年审
    handlePage(row){
      this.$refs.addParagraph.showModal(row.personId,'0',this.formInline.doReviewYear);
    },
    // 查询年审人员信息列表      
    getPersonList() {
      let _this = this
      ...
      _this.$store.dispatch("getAnnualreviewListMoudle", data).then(res => {
