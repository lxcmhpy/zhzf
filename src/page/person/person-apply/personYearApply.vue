    ...
    <div class="searchPage toggleBox">
            ...
            <el-form :inline="true" ref="userForm"  label-width="70px">
                <el-row>
                    <el-form-item label=" " label-width="13px">
                        <el-button type="primary" icon="el-icon-share" size="medium">批量年审</el-button>
        ...
        <div class="tablePart">
            ...
            >
                ...
                <el-table-column prop="" label="所属机构"></el-table-column>
                <el-table-column prop="" label="执法门类"></el-table-column>
                <el-table-column label="操作项" width="160">
                <template slot-scope="scope" >
                    <div style="width:160px">
                    <el-button type="text" @click="handleEdit(scope.$index, scope.row)">审批通过</el-button>
                    <el-button type="text" @click="handleEdit(scope.$index, scope.row)">审批不通过</el-button>
