        ...
        <div class="search">
          <el-form :inline="true" :model="listEducationForm" ref="listEducationForm">
            ...
            <el-form-item label="毕业日期" prop="graduationDate">
              <el-date-picker
                v-model="listEducationForm.graduationDate"
                format="yyyy-MM-dd"
            ...
            <el-form-item>
              <el-button
                ...
                icon="el-icon-plus"
                size="medium"
                @click="addEducationComPage"
              >新增</el-button>
              <el-button type="warning" size="medium" @click="editEducation(scope.row)">修改</el-button>
              <el-button type="info" icon="el-icon-search" size="medium" @click="currentPage = 1 ;getEducation()">查询</el-button>
  ...
  methods: {
    ...
    deleteEducationById(row) {
      ...
      _this
        ...
        .then(() => {
          _this.$store
            .dispatch("deleteEducationByIdMoudle", row.educationId)
            .then(
              res => {
                _this.$message({
                  type: "success",
    ...
    deleteEducation() {
      ...
      this.$confirm("确定要删除所选的人员吗?", "提示", {
        ...
        .then(() => {
          _this.$store
            .dispatch("deleteEducationByIdMoudle", _this.selectDataIdList)
            .then(
              res => {
                _this.$message({
                  type: "success",
