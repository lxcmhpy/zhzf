                ...
                <div class="search">
                 ...
                 <el-form-item label="参数值" prop="paramValue">
                      ...
                      <el-input v-model="paramForm.paramComment"></el-input>
                        ...
                        <el-form-item>
                            <el-button type="info" icon="el-icon-search" size="medium" @click="getParamList">查询</el-button>
            ...
            <div class="tablePart">
                ...
                <el-table-column prop="opt" label="操作项" align="center">
                    <template slot-scope="scope">
                        <el-button  @click="paramInfo(scope.row)" type="text">修改</el-button>
                    </template>
                </el-table-column>
                </el-table>
           </div>
...
export default {
    ...
    methods:{
        ...
        getParamList(){//获取查询列表
            let _this = this
            let data = {
                name:_this.paramForm.name,
                isLce:_this.paramForm.isLce,
                current: _this.currentPage,
                size: _this.pageSize
            };
            _this.$store.dispatch("getParamList", data).then(res => {
