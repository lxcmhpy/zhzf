<template>
  <el-dialog :visible.sync="visible" :close-on-click-modal="false" @close="closeDialog" width="60%">
    <div>
        ...
        <div class="tablePart">
          <el-form :inline="true" :model="searchForm" class="demo-form-inline" size="mini">
            <el-form-item label="文书名称">
              <el-input v-model="searchForm.name" placeholder="请输入文书名称"></el-input>
            </el-form-item>
            <el-form-item>
...
export default {
  ...
  methods: {
    ...
    getLinkDocList() {
      //根据模板Id查询模版问题
      let _this = this;
      getLinkDocListByTemplateIdApi(this.templateId).then(
        res => {
