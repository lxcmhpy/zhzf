    ...
    children: [
      {
        ...
        component: () =>
          import("@/page/inspection/record-manage/writeRecordHome.vue")
      },
      {
        // 写记录
        path:
          "/writeRecordInfo/id=:id&addOrEiditFlag=:addOrEiditFlag&haveDoc=:haveDoc",
        ...
        component: () =>
          import("@/page/inspection/record-manage/writeRecord.vue")
      ...
      // },
      {
        ...
        component: () =>
          import("@/page/inspection/record-manage/recordList.vue")
      },
      {
        ...
        component: () =>
          import("@/page/inspection/record-manage/recordModleManage.vue")
      },
      {
        path: "/recordLog",
        name: "record_log",
        ...
        component: () =>
          import("@/page/inspection/record-manage/record-log/recordLog.vue")
      },
      {
        // 历史检查列表
        path: "/viewRecord",
        ...
        component: () =>
          import("@/page/inspection/record-manage/viewRecord.vue")
      },
      {
        // 历史检查列表
        path: "/test",
      ...
      },
      {
        ...
        component: () =>
          import("@/page/inspection/record-manage/file/correctNotice.vue")
      },
      {
        // 文书-列表
        ...
        component: () =>
          import("@/page/inspection/record-manage/file/fileList.vue")
      },
      // 文书
      {
        // 文书-列表
      ...
      // pdf
      {
        ...
        component: () =>
          import("@/page/inspection/record-manage/file/xzjcPDF.vue")
      },
      // 文书属性配置-----start---------------------------------------------------------------------------------
      {
        ...
        component: () =>
          import("@/page/inspection/record-manage/bindManage/fileTypeBind.vue")
      },
      {
        ...
        component: () =>
          import("@/page/inspection/record-manage/bindManage/fileManage.vue")
      },
      // 双随机-----start----------------------------------------------------------------------------------------------
      {
        // 信息维护
        ...
        component: () =>
          import(
            "@/page/inspection/doubly-stochastic/info-maintains/infoMaintains.vue"
          )
      },
      {
        // 任务管理
        ...
        component: () =>
          import(
            "@/page/inspection/doubly-stochastic/task-manage/taskManage.vue"
          )
      },
      {
        // 检查结果
        ...
        component: () =>
          import(
            "@/page/inspection/doubly-stochastic/check-result/checkResult.vue"
          )
      },
      {
        // 随机抽取
        ...
        component: () =>
          import(
            "@/page/inspection/doubly-stochastic/double-random/doubleRandom.vue"
          )
      },
      // 路警联合----start----------------------------------------------------------------------------------------------
      {
      ...
      },
      {
        ...
        component: () =>
          import("@/page/inspection/roadAndPolice/overWeightList.vue")
      },
      {
        ...
        component: () =>
          import("@/page/inspection/roadAndPolice/imageMange.vue")
      },
      {
        // 文书-列表
      ...
      },
      {
        ...
        component: () =>
          import("@/page/inspection/roadAndPolice/doc/overloadDocumentDoc.vue")
      },
      // 路警联合----end----------------------------------------------------------------------------------------------
      // 勤务管理--排班管理
      {
        ...
        component: () =>
          import("@/page/inspection/dutyManage/dutyScheduling.vue")
      },
      // 勤务管理--记录管理
      {
        path: "/dutyRecord",
      ...
      // 行政检查--记录描述配置
      {
        ...
        component: () =>
          import("@/page/inspection/dutyManage/recordDescription.vue")
      },
      // 行政检查--情况分类配置
      {
        ...
        component: () =>
          import("@/page/inspection/dutyManage/conditionClassify.vue")
      },
      // 勤务管理--日志管理
      {
        path: "/dutyJournal",
      ...
      // 日志管理--添加日志
      {
        ...
        component: () =>
          import("@/page/inspection/dutyManage/components/addJournalPage.vue")
      },
      // 日志管理--交接班
      {
      ...
      // 记录管理--添加记录
      {
        ...
        component: () =>
          import("@/page/inspection/dutyManage/components/recordDetail.vue")
      },
      ...
      // 记录管理--流水号管理
      {
        ...
        component: () =>
          import("@/page/inspection/serial-number/serialManage.vue")
      },
      // 记录管理--巡查执行统计
      {
        ...
        component: () =>
          import("@/page/inspection/dutyManage/inspectionStatistics.vue")
      }
    ]
  }
];
